	 ...
	 <table width="700" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td width="432" height="22"><div align="left">
          <input name="txtcodestpro1" type="text" id="txtcodestpro1" value="<?php print $ls_codestpro1 ?>" size="<?php print $ls_loncodestpro1+1 ?>" maxlength="<?php print $ls_loncodestpro1 ?>"  style="text-align:center">        
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          <input name="txtcodestpro2" type="text" id="txtcodestpro2" value="<?php print  $ls_codestpro2 ?>" size="<?php print $ls_loncodestpro2+2 ?>" maxlength="<?php print $ls_loncodestpro2 ?>"  style="text-align:center">
      ...
      <tr>
        ...
        <td height="22"><label></label></td>
      </tr>
      <tr>
        <td height="22"><div align="right">Codigo</div></td>
        <td height="22"><input name="txtcodigo" type="text" id="txtcodigo" style="text-align:center" value="<?php print $ls_codigo ?>" size="20" maxlength="2"></td>
      </tr>
      <tr>
        <td height="22"><div align="right">Denominacion</div></td>
        <td height="22"><div align="left">
          <input name="txtdenominacion" type="text" id="txtdenominacion" style="text-align:left" value="<?php print $ls_denominacion ?>"  size="90" maxlength="150">
        </div></td>
      </tr>
      <tr>
...
<?php
	 ...
	 */
	 ...
	 $ls_sql=" SELECT SUBSTR(codestpro1,".$li_longestpro1.",25) as codestpro1,                            ".
			 ...
			 "        spg_dt_fuentefinanciamiento.estcla,sigesp_fuentefinanciamiento.codfuefin,           ".
			 ...
			 " AND    spg_dt_fuentefinanciamiento.codemp    = '".$ls_codemp."'                            ".
			 " AND    sigesp_fuentefinanciamiento.codfuefin like  '%".$ls_codigo."%'                      ".
			 " AND    sigesp_fuentefinanciamiento.denfuefin like  '%".$ls_denominacion."%'                ".
			 " AND    spg_dt_fuentefinanciamiento.codestpro1 like '%".$ls_codestpro1."%'                  ".
			 " AND    spg_dt_fuentefinanciamiento.codestpro2 like '%".$ls_codestpro2."%'                  ".
			 " AND    spg_dt_fuentefinanciamiento.codestpro3 like '%".$ls_codestpro3."%'                  ".
 			 " ORDER BY    spg_dt_fuentefinanciamiento.codestpro1,  ".
 			 "            spg_dt_fuentefinanciamiento.codestpro2, spg_dt_fuentefinanciamiento.codestpro3 ,sigesp_fuentefinanciamiento.codfuefin ";
	 ...
	 {	
		while($row=$io_sql->fetch_row($rs_data))
		{
				...
				$ls_estcla     = $row["estcla"];
					...
					print "<td width=50 align=\"center\"><a href=\"javascript: aceptar('$ls_codfuefin','$ls_denestpro5','$ls_estcla');\">".trim($ls_codfuefin)."</td>";
					print "<td width=300 align=\"center\"><a href=\"javascript: aceptar('$ls_denfuefin','$ls_denestpro5','$ls_estcla');\">".trim($ls_denfuefin)."</td>";
					print "<td width=230 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro1','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro1)."</td>";
					print "<td width=120 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro2','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro2)."</td>";
					print "<td width=50 align=\"center\"><a href=\"javascript:  aceptar('$ls_codestpro3','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro3)."</td>";
					print "</tr>";
...
function aceptar(ls_codestpro5,ls_denestpro5,ls_estcla,ls_pantalla)
{
...
function ue_search()
{
   ...
   f.action="sigesp_spg_cat_codestpro_codfuefin.php";
   f.submit();
}
