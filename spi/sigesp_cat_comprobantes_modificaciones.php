...
{ 
		...
		{
		  $ls_cadena2 ="";
		   $ls_sql="SELECT a.procede,a.codemp,a.comprobante,c.fecha,a.ced_bene,a.cod_pro,a.descripcion,a.tipo_destino,SUM(b.monto) as monto".
		 		   " FROM  sigesp_cmp_md a,spi_dtmp_cmp b,spi_dt_cmp c ".
					 ...
					 AND   a.comprobante=c.comprobante 
					 AND   b.comprobante=c.comprobante 					
					 AND   a.procede=b.procede 
					 AND   a.procede=c.procede 
					 AND   b.procede=c.procede					
					 AND   a.fecha=b.fecha 
					 AND   a.fecha=c.fecha 
					 AND   b.fecha=c.fecha 
                     AND   a.tipo_comp=2 
					 ...
					 AND   a.estapro='".$ls_estapro."' ";
		}
		else
		{
		  $ls_cadena2 =" ";
		  $ls_sql="SELECT a.procede,a.codemp,a.comprobante,a.fecha,a.ced_bene,a.cod_pro,a.descripcion,a.tipo_destino,SUM(b.monto) as monto".
		...
		$ls_order=" GROUP BY a.procede,a.codemp,a.comprobante,c.fecha,a.ced_bene,a.cod_pro,a.descripcion,a.tipo_destino
                     ORDER BY fecha, comprobante, procede ASC";
