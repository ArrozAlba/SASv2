  ...
  //--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la 
						 			   'denominacion'=>array('justification'=>'center','width'=>200), // Justificación y  
						 			   'contable'=>array('justification'=>'center','width'=>70),
									   'dencuentas'=>array('justification'=>'center','width'=>220)
									   )
									   ); // Justificación y ancho de la 
		$la_columnas=array('cuenta'=>'<b>Cuenta</b>',
						   'denominacion'=>'<b>Denominación</b>',
						   'contable'=>'<b>Contable</b>',
						   'dencuentas'=>'<b>Denominación</b>');
		...
		if($lb_valido==false) // Existe algún error ó no hay registros
		 ...
		 else
		 {
			...
			for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
			{
				  ...
				  $ls_denominacion=$io_report->dts_reporte->data["denominacion"][$li_s];
				  $ls_sc_cuenta=$io_report->dts_reporte->data["sc_cuenta"][$li_s];
				  $ls_dencuentas=$io_report->dts_reporte->data["dencuentas"][$li_s];  
				  $la_data[$li_s]=array('cuenta'=>$ls_spi_cuenta,'denominacion'=>$ls_denominacion,'contable'=>$ls_sc_cuenta,'dencuentas'=>$ls_dencuentas);
			}
