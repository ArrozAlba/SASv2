...
<form name="form1" method="post" action="">
 <p>&nbsp;</p>
  <table width="581" height="401" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr >
      <td height="43" valign="top"><div align="center"><img src="shared/imagebank/header_banner.png" width="509" height="40">        </div>
      <!--<div align="center" class="estilo_titulo">HUAYRA</div>--></td>
    </tr>
    <tr>
            ...
            <tr align="right" valign="top" class="formato-blanco">
              <td width="329" height="206" valign="middle"><label></label>
                <table width="348" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td>
                      <div align="center" class="Estilo_label">Base de Datos: </div>
                    </td>
                    <td height="27">
                    <div >
    ...
    <select name="cmbdb" onChange="javascript:selec();" style="width:200px">
		...
		?>
                  ...
                  <tr>
                    <td>
                      <div align="center" class="Estilo_label">Empresa: </div>
                    </td>
                    <td height="27"><div ><input name="OPERACION" type="hidden" id="OPERACION" value="<?php $_REQUEST["OPERACION"] ?>">
                      <select name="cmbempresa" style="width:200px ">
