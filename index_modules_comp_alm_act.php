...
<table width="655" height="521" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div align="center" class="Estilo_ubicacion">Compras, Almacen, Activos Fijos</div><br />
    <table width="581" border="0" align="center" height="337" class="fondo_contenido">
      ...
      <tr>
        <td height="54"><div align="center" id="buttom-box">
                      <a href="sep/sigespwindow_blank.php" class="button_eje_pres" target="_self"></a>
             </div></td>
      ...
      <tr>
        <td height="56"><div id="buttom-box" align="center">
              <a href="soc/sigespwindow_blank.php" target="_self" class="button_ord_com"></a>
          </div></td>
      ...
      <tr>
        <td height="54"><div id="buttom-box" align="center">
                      <a href="siv/sigespwindow_blank.php" target="_self" class="button_almacen"></a>
             </div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="54"><div id="buttom-box" align="center">
                      <a href="saf/sigespwindow_blank.php" target="_self" class="button_bienes"></a>
             </div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="58"><div id="buttom-box" align="center">
                      <a href="rpc/sigespwindow_blank.php" target="_self" class="button_proveedores"></a>
             </div></td>
        <td>&nbsp;</td>
