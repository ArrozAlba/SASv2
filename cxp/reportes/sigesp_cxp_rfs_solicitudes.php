...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->addText(150,122,7,"COORD. TESORERÍA"); // Agregar el título
					...
					//-------------------------------CARGOS-------------------------------------- 										                       									
						...
						if ($lb_validocar)
						{
							   ...
							   {										  													  
									  ...
									  $ls_estpro3   = $io_report->ds_car_dt->data["denestpro3"][$b]; 
									  $ls_dencar    = $io_report->uf_select_dencar($ls_codcar);	
									  $ls_dencar    = substr($ls_dencar,0,8);
						  			  $ls_dencar 	= $ls_dencar." - ".$ls_estpro3;				  
									  $ld_monobjret = $io_report->ds_car_dt->data["monobjret"][$b];
									  $ld_objret    = $io_report->ds_car_dt->data["monret"][$b];
									  if($ld_objret<>"0.0000")
									  {
						...
						if ($lb_validoded)
						{
							   ...
							   {										
									  ...
									  $ls_dended    = $io_report->uf_select_dended($ls_codded);																  									
									  ...
									  $la_datacar[$b]= array('codigo'=>$ls_codded,'denominacion'=>$ls_dended,
