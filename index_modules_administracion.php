...
<table width="655" height="521" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div align="center" class="Estilo_ubicacion">Contabilidad y Presupuesto</div><br />
    <table width="581" border="0" align="center" height="337" class="fondo_contenido">
      ...
      <tr>
        <td height="54"><div align="center" id="buttom-box">
                      <a href="scg/sigespwindow_blank.php" class="button_contgeneral" target="_self"></a>
             </div></td>
      ...
      <tr>
        <td height="56"><div id="buttom-box" align="center">
              <a href="spg/sigespwindow_blank.php" target="_self" class="button_presgasto"></a>
          </div></td>
      ...
      <tr>
        <td height="54"><div id="buttom-box" align="center">
              <a href="spi/sigespwindow_blank.php" target="_self" class="button_presingreso"></a>
          </div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="54"><div id="buttom-box" align="center">
                      <a href="cxp/sigespwindow_blank.php" target="_self" class="button_ctasxpagar"></a>
             </div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="54"><div id="buttom-box" align="center">
                      <a href="scb/sigespwindow_blank.php" target="_self" class="button_cajabanco"></a>
             </div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="58"><div id="buttom-box" align="center">
                      <a href="scv/sigespwindow_blank.php" target="_self" class="button_viaticos"></a>
             </div></td>
        <td>&nbsp;</td>
