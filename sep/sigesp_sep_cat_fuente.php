...
function ue_search()
{
	...
	ajax.send("catalogo=FUENTEFINANCIAMIENTO&tipo="+tipo+"&orden="+orden+"&campoorden="+campoorden+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5+"&estcla="+estcla);
}
</script>
</html>