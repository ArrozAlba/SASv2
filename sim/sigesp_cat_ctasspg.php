...
if($ls_operacion=="BUSCAR")
{
	$ls_cadena ="SELECT * FROM spg_cuentas ".
				...
				" AND spg_cuenta ilike '".$ls_codigo."'".
				" AND denominacion ilike '".$ls_denominacion."'".
				" AND sc_cuenta ilike '".$ls_codscg."'".
				" AND codestpro1 ilike '%".$ls_estpro1."%'".
				" AND codestpro2 ilike '%".$ls_estpro2."%'".
				" AND codestpro3 ilike '%".$ls_estpro3."%'".
				" ORDER BY spg_cuenta";
