...
<?php
	...
	{
		/*$ls_sql="SELECT * FROM sim_almacen".
				" WHERE codemp = '".$ls_codemp."'".
				" AND codalm iLIKE '".$ls_codalm."'".
				" AND nomfisalm iLIKE '".$ls_nomfisalm."'";
		
		print $ls_sql;		*/
		
		$ls_sql="SELECT a.* FROM sim_almacen a, sfc_tienda t".
				" WHERE a.codemp = '".$ls_codemp."'".
				" AND a.codalm iLIKE '".$ls_codalm."'".
				" AND a.nomfisalm iLIKE '".$ls_nomfisalm."'".
				" AND t.codtiend iLIKE substr(a.codalm,7,4)";
	...
	function ue_search()
  	{
		...
		f.action="sigesp_sim_cat_almacenestoma.php";
		f.submit();
	}
</script>
</html>
