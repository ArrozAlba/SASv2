...
$io_fun_activo->uf_load_seguridad("SIM","sigesp_sim_r_valajustes.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td width="458" height="20" bgcolor="#E7E7E7" class="Estilo2 descripcion_sistema">Sistema de Inventario</td>
    <td width="320" bgcolor="#E7E7E7" class="cd-menu"><div align="right"><b><?PHP print date("j/n/Y")." - ".date("h:i a");?></b></div></td>
    <td width="18" height="20" bgcolor="#E7E7E7" class="cd-menu"><div align="right"></div></td>
  ...
  <tr>
    ...
    <td height="20" bgcolor="#E7E7E7" class="cd-menu"><div align="right"></div></td>
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				{
					window.open("reportes/sigesp_sim_rpp_valajustes.php?desde="+ld_desde+"&hasta="+ld_hasta+"&agro_desde="+ld_agro_desde+"&agro_hasta="+ld_agro_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
