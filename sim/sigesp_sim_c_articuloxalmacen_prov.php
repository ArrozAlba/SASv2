...
class sigesp_sim_c_articuloxalmacen_prov
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function sigesp_sim_c_articuloxalmacen_prov()
	{
	...
	function uf_sim_select_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$as_codtiend,$as_codpro)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql = "SELECT * FROM sim_articuloalmacen  ".
				  ...
				  " AND codtiend='".$as_codtiend."'".
				  " AND cod_pro='".$as_codpro."'";
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_select_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_insert_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$as_existencia,$as_codtiend,$as_codpro,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="INSERT INTO sim_articuloalmacen (codemp, codart, codalm, existencia, codtiend, cod_pro)".
				" VALUES ('".$as_codemp."','".$as_codart."','".$as_codalm."','".$as_existencia."', '".$as_codtiend."','".$as_codpro."')";
		$li_row=$this->io_sql->execute($ls_sql);
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_insert_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
...
/*				$ls_evento="INSERT";
	...
	function uf_sim_update_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$as_existencia,$as_codtiend,$as_codpro)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_update_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
...
/*			$ls_evento="UPDATE";
	...
	function uf_sim_chequear_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$as_codtiend,$as_codpro)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_chequear_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_disminuir_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$aa_seguridad,$as_codtiend,$as_codpro)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 $lb_valido=true;
	 $lb_valido=$this->uf_sim_chequear_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$as_codtiend,$as_codpro);
	 if($lb_valido)
	 {
		 $ls_sql =  "UPDATE sim_articuloalmacen".
			...
			if($li_row===false)
			{
				$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_disminuir_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
	...
	function uf_sim_sumar_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$aa_seguridad,$as_codtiend,$as_codpro)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_sumar_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
	...
	function uf_sim_aumentar_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$as_codtiend,$as_codpro,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Fecha Creación: 01/01/2006 								Fecha Última Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if(!($this->uf_sim_select_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$as_codtiend,$as_codpro)))
		{
			$lb_valido=$this->uf_sim_insert_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$as_codtiend,$as_codpro,$aa_seguridad);
		}
		else
		{
			$lb_valido=$this->uf_sim_sumar_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$aa_seguridad,$as_codtiend,$as_codpro);
		}
		return $lb_valido;
	}
	...
	function uf_sim_select_articulo($as_codemp,$as_codart)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_select_articulo ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
...
//			 		  "   SET exiart= (exiart - '". $ai_cantidad ."') ".
				...
				if($li_row===false)
				{
					$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_disminuir_articulo ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
					$lb_valido=false;
				}
				else
				{
...
//			 		  "   SET exiart='". $ai_cantidad ."' ".
				...
				if($li_row===false)
				{
					$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_update_total_articulo ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
					$lb_valido=false;
				}
				else
				{
...
/*					$ls_evento="UPDATE";
	...
	function uf_sim_actualizar_cantidad_articulos($as_codemp,$as_codart,$as_codalm,$aa_seguridad,$as_codtiend,$as_codpro)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_sim_delete_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$as_codtiend,$as_codpro)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql= "DELETE FROM sim_articuloalmacen".
				 " WHERE codemp= '".$as_codemp. "'".
				 "   AND codart= '".$as_codart. "'".
				 "   AND codalm= '".$as_codalm. "'".
				 "   AND codtiend='".$as_codtiend."'".
			...
			if($li_row===false)
			{
				$this->io_msg->message("CLASE->articuloxalmacen_prov MÉTODO->uf_sim_delete_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
				$this->io_sql->rollback();
			}
			else
