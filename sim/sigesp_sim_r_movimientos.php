...
$io_fun_activo->uf_load_seguridad("SIM","sigesp_sim_r_movimientos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" width="20" height="20" border="0"></a><a href="javascript:uf_mostrar_reporte();"><img src="../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" width="20" height="20" border="0"></a>
    <a href="../sim/sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0"></a>
...
else
{
	...
	if ($ls_operacion=="REPORT")
	{
		...
		{
			$ls_descfec=" Desde el  ".$ld_fecdesde." hasta el ".$ld_fechasta;
		}
		else
		{
			$ls_descfec="";
		...
		$ls_evento="REPORT";
		$ls_descripcion="Gener� un reporte de movimientos. ". $ls_descfec ;
		...
		//ls_ano = f.ano.value;
			...
			else
			{
				...
				else
				{
						...
						pagina="reportes/sigesp_sim_rpp_movimientos_excel.php?codart="+ls_codart+"&codalm="+ls_codalm+"&fecdesde="+ld_desde+"&fechasta="+ld_hasta+"&agro_desde="+ld_agro_desde+"&agro_hasta="+ld_agro_hasta+"";
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir)
			{
				...
				window.open("reportes/sigesp_sim_rpp_movimientos.php?codart="+ls_codart+"&codalm="+ls_codalm+"&ordenfec="+li_ordenfec+"&ordenart="+li_ordenart+"&desde="+ld_desde+"&hasta="+ld_hasta+"&agro_desde="+ld_agro_desde+"&agro_hasta="+ld_agro_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="sigesp_sim_r_movimientos.php";
				//f.submit();
			}
		}
		else
