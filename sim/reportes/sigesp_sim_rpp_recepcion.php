<?php
	...
	function uf_print_cabecera($as_numordcom,$ad_fecrec,$as_nomfisalm,$as_denpro,&$io_pdf)
	{
		...
		$la_data=array(array('name'=>'<b>Orden de Compra</b>  '.$as_numordcom.'                                                   <b>Proveedor</b>  '.$as_denpro.''),
	...
	$ls_titulo="<b> Reporte de Entradas de Suministros </b>";
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_select_recepcion($ls_codemp,"",$ld_desde,$ld_hasta,$li_ordenfec,$ls_tienda_desde,$ls_tienda_hasta); // Cargar el DS con los datos de la cabecera del reporte
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$lb_valido=$io_report->uf_select_dt_recepcion($ls_codemp,$ls_numordcom,$ls_numconrec,$ls_tienda_desde,$ls_tienda_hasta);// Obtenemos el detalle del reporte
			if($lb_valido)
			{
