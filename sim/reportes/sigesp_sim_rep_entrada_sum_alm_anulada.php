<?php
	...
	function uf_print_encabezado_pagina($ad_fechaanula,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$ls_titulo= utf8_decode("<b>COMPROBANTE DE ANULACIÓN ENTRADA DE SUMINISTRO A ALMACEN</b>");
		...
		$io_pdf->addText(90,122,7,"Analista de Inventario:"); // Agregar el título
		$io_pdf->addText(240,122,7,utf8_decode("Coordinador de Inventario:")); // Agregar el título
		$io_pdf->addText(430,122,7,"Contabilidad:"); // Agregar el título
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_numdoc,$ad_fecmov,$ad_fechaanula,$as_conanu,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->EzSetY(595);
		$la_data=array(array('numdoc'=>$as_numdoc,'fecmov'=>$ad_fecmov));
		$la_columna=array('numdoc'=>'Entrada de Suministro','fecmov'=>utf8_decode('EMISIÓN'));
...
/*		$la_data=array(array('ordenes'=>'<b>Orden(es) de Pago(s):</b> '.$ls_solicitudes),
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($as_codemp, $as_numordcom,$as_codtie,$as_numconrec, &$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
               ...
               $sql = "
                SELECT
                    ...
                    , dt_re.canart
                FROM
                    sim_dt_recepcion dt_re
                    , sim_articulo art
                WHERE
                        art.codart = dt_re.codart
                    AND dt_re.codemp ='$as_codemp'
		    AND dt_re.numordcom='$as_numordcom'
		    AND dt_re.codtiend ='$as_codtie'
		    AND dt_re.numconrec='$as_numconrec'
                ";
                $rs = pg_query($sql);
                ...
                //print_r($la_data_nm);
                    ...
                    while($la_data_nm = pg_fetch_array($rs))
                    {
                                            ...
                                            $ls_canart = $la_data_nm['canart'];;
                                            $ls_canart=number_format($ls_canart,2,",",".");

                                            $la_data[$li_s]=array('codart'=>$ls_codart,'denart'=>$ls_denart,'canart'=>$ls_canart);
                                            $li_s++;
                                            //print_r($la_data);
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>195),
									   ...
									   'denart'=>array('justification'=>'center','width'=>220),
                                                                           'canart'=>array('justification'=>'center','width'=>80))); // Justificación y ancho de la columna
		$la_columnas=array('codart'=>utf8_decode('<b>Codigo del Articulo:</b>'),
						   'denart'=>utf8_decode('<b>Denominación:</b>'),
                                                   'canart'=>utf8_decode('<b>Cantidad:</b>'));
	...
	//imprime numero con los cambios
        ...
        $as_codemp=$_GET["codemp"];
        $as_numordcom=$_GET["numordcom"];
        $as_codtie=$_GET["codtiend"];
	$as_numconrec=$_GET["numconrec"];
        
        $sql = "
        SELECT
           codalm,
           to_char(fecrec,'DD/MM/YYYY') as fecrec,
           to_char(fecanu,'DD/MM/YYYY') as fecanu,
           obsanu
        FROM
           sim_recepcion
        WHERE
        ...
        $fechaEmision=$row["fecrec"];
        //$monto=number_format($row["moncob"],2,',','.');;
	...
	$thisPageNum=$io_pdf->ezPageCount;
		...
		uf_print_encabezado_pagina($fechaAnulacion,&$io_pdf);
                uf_print_detalle($as_codemp, $as_numordcom,$as_codtie,$as_numconrec,&$io_pdf);
		uf_print_cabecera($as_numconrec,$fechaEmision,$fechaAnulacion,$obsAnulacion,$io_pdf); // Imprimimos la cabecera del registro
