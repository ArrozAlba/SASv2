<?php
	...
	$ls_tienda=$io_fun_inventario->uf_obtenervalor_get("codtiend","");
	
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_select_toma($ls_codemp,$ls_numtom,$ld_fectom,$ld_fectom,$ls_tienda,$ls_tienda); // Cargar el DS con los datos de la cabecera del reporte
