<?php
	...
	$ls_tienda_desde=$io_fun_inventario->uf_obtenervalor_get("codtiend","");
	$ls_tienda_hasta=$io_fun_inventario->uf_obtenervalor_get("codtiend","");
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$lb_valido=$io_report->uf_select_articuloxalmacen($ls_codemp,$ls_codalm,$ls_codart,$li_ordenalm,$li_ordenart,$ls_tienda_desde,$ls_tienda_hasta,$ls_codpro,&$rs_data); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
				$li_s=0;
