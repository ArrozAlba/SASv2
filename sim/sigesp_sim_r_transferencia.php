...
$io_fun_activo->uf_load_seguridad("SIM","sigesp_sim_r_transferencia.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    ...
    <td width="3" height="20" colspan="4" bgcolor="#E7E7E7" class="cd-menu"><div align="right"></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="538" bgcolor="#FFFFFF" class="toolbar"><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20"></td>
    <td width="197" bgcolor="#FFFFFF" class="toolbar">&nbsp;</td>
    <td width="3" bgcolor="#FFFFFF" class="toolbar">&nbsp;</td>
  </tr>
</table>
<?php
...
else
{
	...
	if ($ls_operacion=="REPORT")
	{
		...
		$ls_evento="REPORT";
		$ls_descripcion="Gener� un reporte de transferencia entre almacenes. Desde el  ". $ld_fecdesde ." hasta el ".$ld_fechasta;
  ...
  <table width="442" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <tr>
      <td height="33" colspan="3" align="center">      <div align="left">
        ...
        <table width="415" height="90" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
			      ...
			      window.open("reportes/sigesp_sim_rpp_transferencia.php?ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"&agro_desde="+ld_agro_desde+"&agro_hasta="+ld_agro_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");


					//window.open("reportes/sigesp_sim_rpp_transferencia.php?ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
					f.operacion.value="REPORT";
					f.action="sigesp_sim_r_transferencia.php";
					//f.submit();
				}
				else
				{
