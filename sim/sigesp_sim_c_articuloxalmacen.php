...
class sigesp_sim_c_articuloxalmacen
{
	...
	function uf_sim_select_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$as_codpro,$as_codtiend)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_sim_insert_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$as_existencia,$aa_seguridad,$as_codpro,$as_codtie)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="INSERT INTO sim_articuloalmacen (codemp, codart, codalm, existencia,cod_pro,codtiend)".
				" VALUES ('".$as_codemp."','".$as_codart."','".$as_codalm."','".$as_existencia."','".$as_codpro."','".$as_codtie."')";
		$li_row=$this->io_sql->execute($ls_sql);
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->articuloxalmacen M�TODO->uf_sim_insert_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
/*				$ls_evento="INSERT";
				$ls_descripcion ="Insert� el Articulo ".$as_codart." en el Almac�n ".$as_codalm." de la Empresa ".$as_codemp;
...
/*			$ls_evento="UPDATE";
	...
	function uf_sim_chequear_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$as_codpro,$as_codtiend)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql = "SELECT * FROM sim_articuloalmacen  ".
				  " WHERE codemp='".$as_codemp."'".
				  " AND codart='".$as_codart."'".
				  " AND codalm='".$as_codalm."' AND cod_pro='".$as_codpro."' AND codtiend='".$as_codtiend."'";
				//  print $ls_sql;
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
	...
	function uf_sim_disminuir_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$as_codpro,$as_codtie,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 $lb_valido=true;
	 $lb_valido=$this->uf_sim_chequear_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$as_codpro,$as_codtie);
	 if($lb_valido)
	 {
		 $ls_sql =  "UPDATE sim_articuloalmacen".
			...
			if($li_row===false)
			{
				$this->io_msg->message("CLASE->articuloxalmacen M�TODO->uf_sim_disminuir_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
			...
			else
			{
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="UPDATE";
				$ls_descripcion ="Disminuy� ".$ai_cantidad." Articulos ".$as_codart." del Almac�n ".$as_codalm." de la Empresa ".$as_codemp;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	function uf_sim_sumar_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$aa_seguridad,$as_codpro)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->articuloxalmacen M�TODO->uf_sim_sumar_articuloxalmacen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			//$this->io_sql->rollback();
		...
		else
		{
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion ="Aument� ".$ai_cantidad." Articulos ".$as_codart." del Almac�n ".$as_codalm." de la Empresa ".$as_codemp;
			$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	function uf_sim_aumentar_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$aa_seguridad,$as_codpro,$as_codtie)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if(!($this->uf_sim_select_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$as_codpro,$as_codtie)))
		{
			$lb_valido=$this->uf_sim_insert_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$aa_seguridad,$as_codpro,$as_codtie);
		}
		else
		{
			$lb_valido=$this->uf_sim_sumar_articuloxalmacen($as_codemp,$as_codart,$as_codalm,$ai_cantidad,$aa_seguridad,$as_codpro);
		}
		return $lb_valido;
	}
...
/*					$ls_evento="UPDATE";
	...
	function uf_sim_actualizar_cantidad_articulos_alm($as_codemp,$as_codart,$as_codalm,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_actualizar_cantidad_articulos
		//         Access: public 
