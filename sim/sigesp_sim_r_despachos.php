...
$io_fun_activo->uf_load_seguridad("SIM","sigesp_sim_r_despachos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" colspan="3" bgcolor="#E7E7E7" class="cd-menu"><div align="left"><span class="descripcion_sistema Estilo1">Sistema de Inventario</span></div></td>
    <td height="20" bgcolor="#E7E7E7" class="cd-menu"><div align="right"><b><?PHP print date("j/n/Y")." - ".date("h:i a");?></b></div></td>
    <td width="11" height="20" colspan="4" bgcolor="#E7E7E7" class="cd-menu"><div align="right"></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="498" bgcolor="#FFFFFF" class="toolbar"><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20"></td>
    <td width="230" bgcolor="#FFFFFF" class="toolbar">&nbsp;</td>
  </tr>
</table>
<?php
...
else
{
	...
	if ($ls_operacion=="REPORT")
	{
		...
		$ls_evento="REPORT";
		$ls_descripcion="Gener� un reporte de ordenes de despacho. Desde el  ". $ld_fecdesde ." hasta el ".$ld_fechasta;
...
<td colspan="15" align="center">
    <table width="438" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="1" class="titulo-ventana">Reporte de &Oacute;rdenes de Despacho </td>
    </tr>
	</table>
    ...
    <tr>
      <td height="33" colspan="3" align="center">      <div align="left">
        ...
        <table width="435" height="190" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <table width="420" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <?php
                   ...
                   <input type="hidden" name="hdnagrotienda" value=""/>
					...
					<tr>
		                <td width="119" height="22" align="right">Desde Unidad Operativa de Suministro:</td>
		                <td colspan="2" >
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
					...
					window.open("reportes/sigesp_sim_rpp_despachos.php?ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"&agro_desde="+ld_agro_desde+"&agro_hasta="+ld_agro_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
					f.operacion.value="REPORT";
					f.action="sigesp_sim_r_despachos.php";
					//f.submit();
				}
				else
				{
