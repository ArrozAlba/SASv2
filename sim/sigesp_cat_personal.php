	...
	function uf_imprimirresultados($as_codper, $as_cedper, $as_nomper, $as_apeper)
   	{
		...
		$ls_sql=$ls_sql."  AND sno_personal.codper ilike '".$as_codper."' AND sno_personal.cedper ilike '".$as_cedper."'";
		$ls_sql=$ls_sql."  AND sno_personal.nomper ilike '".$as_nomper."' AND sno_personal.apeper ilike '".$as_apeper."'";
