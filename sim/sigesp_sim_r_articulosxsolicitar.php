...
$io_fun_activo->uf_load_seguridad("SIM","sigesp_sim_r_articuloxsolicitar.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  <tr>
    <td height="30" colspan="3" class="cd-logo"><img src="../shared/imagebank/header.jpg" width="778" height="40"></td>
  </tr>
<tr>
    <td width="408" height="20" bgcolor="#E7E7E7" class="cd-menu"><span class="Estilo2 descripcion_sistema"><strong>Sistema de Inventario</strong></span></td>
    <td width="322" bgcolor="#E7E7E7" class="cd-menu"><div align="right"><b><?PHP print date("j/n/Y")." - ".date("h:i a");?></b></div></td>
  ...
  <tr>
    ...
    <td height="20" colspan="8" bgcolor="#E7E7E7" class="cd-menu"><div align="right"><b>
	<?PHP print $_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"];?></b> </div></td>
    <td height="20" colspan="4" bgcolor="#E7E7E7" class="cd-menu"><div align="right"></div></td>
  </tr>  <tr>
    <td height="20" colspan="3" class="cd-menu"><script type="text/javascript" language="JavaScript1.2" src="js/menu.js"></script></td>
  </tr>
  <tr>
    <td height="13" colspan="9" class="toolbar">&nbsp;</td>
  </tr>
  <tr>
...
?>
  ...
  <table width="500" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="2" class="titulo-ventana">Listado  de Productos a Solicitar</td>
    </tr>
  </table>
  <table width="494" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
       ...
       <td colspan="5" align="center"><table width="465" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td colspan="2"><strong> Productos </strong></td>
                ...
                <tr>
          <td width="147"><div align="right">Desde</div></td>
          <td width="316" height="22"><div align="left">
...
/************************* Unidad Operativa de Suministro ***************************************/
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			{li_ordenart=1;}
			window.open("reportes/sigesp_sim_rpp_articulosxsolicitar.php?ordenart="+li_ordenart+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&agro_desde="+ld_agro_desde+"&agro_hasta="+ld_agro_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
