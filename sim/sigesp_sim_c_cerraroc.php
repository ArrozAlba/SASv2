...
class sigesp_sim_c_cerraroc
{
	...
	function sigesp_sim_c_cerraroc()
	{
	...
	function uf_sim_load_ordenes(&$ai_totrows,&$ao_object,$as_estmov,$ad_fecdes,$ad_fechas)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_load_ordenes
		//         Access: public 
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_load_ordenes ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_i=0;
		...
		{$lb_valido=false;}
		return $lb_valido;
	} // end  function uf_sim_load_ordenes
	...
	function uf_sim_update_statusorden($as_codemp,$as_numordcom,$as_estpenalm,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_update_statusorden
		//         Access: public  
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_update_statusorden ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$lb_valido=true;
		...
		return $lb_valido;
	}  // end  function uf_sim_update_statusorden

	function uf_sim_load_dt_ordencompra($as_codemp,$as_numordcom)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_load_dt_ordencompra
		//         Access: private
		//      Argumento: $as_codemp    // codigo de empresa
		//  			   $as_numordcom // numero de la orden de compra/factura
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->recepcion MÉTODO->uf_sim_obtener_dt_bienes ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
		...
		$this->io_sql->free_result($rs_data);
		return $lb_valido;
	} // end function uf_sim_load_dt_ordencompra

	function uf_sim_load_ordencompra($as_codemp,$as_numordcom,&$ad_fecordcom,&$as_coduniadm)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_load_ordencompra
		//         Access: public  
		//      Argumento: $as_codemp    // codigo de empresa 
		//                 $as_numordcom // numero de orden de compra
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_load_ordencompra ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
		...
		return $lb_valido;
	}  // end function uf_sim_load_ordencompra
	
	function uf_sim_load_cargosarticulo($as_codemp,$as_codart,$ai_preuniart,$ai_pendiente,$ai_unidad,&$aa_moncar,&$aa_spgcuenta,
										&$ai_i)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_load_cargosarticulo
		//         Access: public  
		//      Argumento: $as_codemp    // codigo de empresa 
		...
		$ls_sql = "SELECT codcar,".
				  ...
				  "	        WHERE sim_cargosarticulo.codemp = sigesp_cargos.codemp".
				  "           AND sim_cargosarticulo.codcar = sigesp_cargos.codcar) AS spg_cuenta,".
				  "       (SELECT porcar FROM sigesp_cargos".
				  "	        WHERE sim_cargosarticulo.codemp = sigesp_cargos.codemp".
				  "           AND sim_cargosarticulo.codcar = sigesp_cargos.codcar) AS porcar".
				  "  FROM sim_cargosarticulo".
				  "	WHERE sim_cargosarticulo.codemp='".$as_codemp."'".
				  "   AND sim_cargosarticulo.codart='".$as_codart."'";
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_load_cargosarticulo ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
		...
		return $lb_valido;
	}  // end function uf_sim_load_cargosarticulo

	function uf_sim_load_estpre($as_codemp,$as_coduniadm,&$as_codestpro1,&$as_codestpro2,&$as_codestpro3,
							    &$as_codestpro4,&$as_codestpro5)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_load_estpre
		//         Access: public  
		//      Argumento: $as_codemp      // codigo de empresa 
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_load_estpre ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
		...
		return $lb_valido;
	}  // end function uf_sim_load_estpre

	function uf_sim_load_cuentaspg($as_codemp,$as_codart,&$as_spgcuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_load_cuentaspg
		//         Access: public  
		//      Argumento: $as_codemp    // codigo de empresa 
		//                 $as_codart    // codigo de articulo
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_load_cuentaspg ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
		...
		return $lb_valido;
	}  // end function uf_sim_load_cuentaspg

	function uf_sim_procesar_comprobante($as_codemp,$as_procede,$as_numordcom,$ad_newfeccmp,$as_newprocede,&$as_newcomprobante,&$ad_feccmp,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_procesar_comprobante
		//         Access: public  
		//      Argumento: $as_codemp         // codigo de empresa 
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
		$lb_valido=$this->uf_sim_load_cmp($as_codemp,$as_procede,$as_numordcom,$ad_feccmp,$as_tipocomp,$as_tipodestino,
										  $as_codpro,$as_cedbene);
		if($lb_valido)
		{
			$lb_valido=$this->uf_sim_obtener_numerocomprobante($as_codemp,$as_newprocede,$as_newcomprobante);
		}
		return $lb_valido;
	}  // end function uf_sim_procesar_comprobante
	
	function uf_sim_load_dt_pendiente($as_codemp,$as_numordcom,$as_coduniadm,&$li_totmonart,&$li_totmoncar,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_load_dt_pendiente
		//         Access: private
		//      Argumento: $as_codemp    // codigo de empresa
		//  			   $as_numordcom // numero de la orden de compra/factura
		...
		$li_totmoncar=0;
		$ad_fecordcom="";
		$lb_valido=$this->uf_sim_load_estpre($as_codemp,$as_coduniadm,$as_codestpro1,$as_codestpro2,$as_codestpro3,
											 $as_codestpro4,$as_codestpro5);
		if($lb_valido)
		{
			...
			{
				$lb_valido=false;
				$this->io_msg->message("CLASE->recepcion MÉTODO->uf_sim_load_dt_pendiente_I ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
				return false;
			}
			else
			{
				...
				$ls_tipo_destino= "-";
				$ls_codigo_destino="----------";
				$lb_valido=$this->uf_sim_procesar_comprobante($as_codemp,$ls_procede,$as_numordcom,$ld_newfeccmp,$ls_newprocede,
															  $as_newcomprobante,$ad_feccmp,$aa_seguridad);

				if($lb_valido)
				{
					$lb_valido = $this->io_sigesp_int->uf_int_init($as_codemp,$ls_newprocede,$as_newcomprobante,$ld_newfeccmp,$ls_descmp,$ls_tipo_destino,$ls_codigo_destino,false,'---','--------------------',1);
				}												  
				while($row=$this->io_sql->fetch_row($rs_data))
				{
					$ls_codart=$row["codart"];
					...
					{
						$ls_sql=  "SELECT sim_dt_recepcion.*,sim_articulo.codunimed,sim_cargosarticulo.codcar,".
								  "      (SELECT unidad FROM sim_unidadmedida ".
								  "	       WHERE sim_unidadmedida.codunimed = sim_articulo.codunimed) AS unidades,".
								  "      (SELECT denart FROM sim_articulo".
								  "        WHERE sim_dt_recepcion.codart=sim_articulo.codart) AS denart".
								  "  FROM sim_dt_recepcion, sim_recepcion,sim_articulo,sim_cargosarticulo".
								  " WHERE  sim_dt_recepcion.codemp=sim_recepcion.codemp".
								  "   AND sim_dt_recepcion.codart=sim_articulo.codart".
								  "   AND sim_dt_recepcion.numordcom=sim_recepcion.numordcom".
								  "   AND sim_dt_recepcion.numconrec=sim_recepcion.numconrec ".
					...
					{
						$lb_valido=false;
						$this->io_msg->message("CLASE->recepcion MÉTODO->uf_sim_load_dt_pendiente_II ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
					}
					else
					{
						if($row=$this->io_sql->fetch_row($rs_data1))
						{
							...
							if($li_penart>0)
							{
								...
								$lb_valido=$this->uf_sim_load_cuentaspg($as_codemp,$ls_codart,$as_spgcuenta);
								if($lb_valido)
								{
									$lb_valido=$this->uf_sim_load_cargosarticulo($as_codemp,$ls_codart,$li_preuniart,
								...
								{
									$lb_valido=$this->uf_sim_load_dt_cmp($as_codemp,$ls_procede,$as_numordcom,$as_codestpro1,
				...
				for($z=1;$z<=$totrow;$z++)
				{
					...
					$lb_valido=$this->uf_sim_load_dt_cmp($as_codemp,$ls_procede,$as_numordcom,$as_codestpro1,$as_codestpro2,
	...
	function uf_sim_load_cmp($as_codemp,$as_procede,$as_comprobante,&$ad_feccmp,&$as_tipocomp,&$as_tipodestino,&$as_codpro,&$as_cedbene)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_load_cmp
		//         Access: public  
		//      Argumento: $as_codemp      // codigo de empresa 
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_load_cmp ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
		...
		return $lb_valido;
	}  // end function uf_sim_load_cmp

	function uf_sim_load_dt_cmp($as_codemp,$as_procede,$as_comprobante,$as_codestpro1,$as_codestpro2,$as_codestpro3,
								$as_codestpro4,$as_codestpro5,$as_spgcuenta,&$as_operacion,&$as_documento,&$as_procededoc,&$ai_orden)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_load_dt_cmp
		//         Access: public  
		//      Argumento: $as_codemp      // codigo de empresa 
		//                 $as_procede     // codigo de procedencia
		//                 $as_comprobante // numero de comprobante
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_load_dt_cmp ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
		...
		return $lb_valido;
	}  // end function uf_sim_load_dt_cmp

	function uf_sim_obtener_numerocomprobante($as_codemp,$as_procede,&$as_comprobante)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_obtener_numerocomprobante
		//         Access: public  
		//      Argumento: $as_codemp      // codigo de empresa 
		//                 $as_procede     // codigo de procedencia
		//                 $as_comprobante // numero de comprobante
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_obtener_numerocomprobante ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
		...
		return $lb_valido;
	}  // end function uf_sim_obtener_numerocomprobante
...
/*	function  uf_sim_insert_cmp($as_codemp,$as_procede,$as_comprobante,$ad_feccmp,$as_desccmp,$as_tipocomp,$as_tipodestino,
								$as_codpro,$as_cedbene,$as_total,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_insert_cmp
		//         Access: public 
		//      Argumento: $as_codemp      //codigo de empresa 
		//				   $as_procede     //procedencia del comprobante
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_insert_cmp ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
		...
		return $lb_valido;
	} //end function  uf_sim_insert_cmp

	function  uf_sim_insert_dt_cmp($as_codemp,$as_newprocede,$as_comprobante,$ad_feccmp,$as_codestpro1,$as_codestpro2,
								   ...
								   $as_operacion,$as_descripcion,$ai_monto,$ai_orden,$aa_seguridad)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->cerrar_oc MÉTODO->uf_sim_insert_dt_cmp ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		return $lb_valido;
	} //end function  uf_sim_insert_dt_cmp
*/	

}//end  class sigesp_sim_c_cerraroc
?>
