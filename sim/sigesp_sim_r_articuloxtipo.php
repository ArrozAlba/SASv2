...
$io_fun_activo->uf_load_seguridad("SIM","sigesp_sim_r_articuloxtipo.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" colspan="3" bgcolor="#E7E7E7" class="cd-menu"><span class="descripcion_sistema Estilo1">Sistema de Inventario</span></td>
  ...
  <tr> 
    ...
    <td width="428" bgcolor="#FFFFFF" class="toolbar"><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20"></td>
    <td width="310" bgcolor="#FFFFFF" class="toolbar">&nbsp;</td>
  </tr>
</table>
<?php
    ...
    <tr>
      <td height="53" colspan="5" align="center">      <div align="left">
        <table width="427" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="2"><strong>Tipos de Productos </strong></td>
            </tr>
          <tr>
    ...
    <tr>
      <td colspan="5" align="center"><div align="left">
        <table width="427" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td colspan="2"><div align="center" class="Estilo1">Productos</div></td>
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			if((ls_coddesde!="")&&(ls_codhasta!=""))
			{
				...
				window.open("reportes/sigesp_sim_rpp_articuloxtipo.php?coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&ordenart="+li_ordenart+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="sigesp_sim_r_articuloxtipo.php";
				//f.submit();
			}
			else
			{
