...
class sigesp_sim_c_transferencia
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function sigesp_sim_c_transferencia()
	{
	...
	function uf_sim_select_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codtiend)
	{
		...
		$ls_sql = "SELECT * FROM sim_transferencia  ".
				  ...
				  "   AND fecemi='".$ad_fecemi."' AND codtiend='".$as_codtiend."'";
...
function uf_sim_insert_transferencia($as_codemp,&$as_numtra,$ad_fecemi,$as_codusu,$as_codalmori,$as_codalmdes,$as_obstra,$aa_seguridad,$ls_codtiend)
	{
		...
		$ls_sql="INSERT INTO sim_transferencia (codemp, numtra, fecemi, codusu, obstra, codalmori, codalmdes,codtiend)".
				" VALUES ('".$as_codemp."','".$as_numtra."','".$ad_fecemi."','".$as_codusu."','".$as_obstra."',".
				"         '".$as_codalmori."','".$as_codalmdes."','".$ls_codtiend."')";
...
function uf_sim_update_transferencia($as_codemp,&$as_numtra,$ad_fecemi,$as_codusu,$as_codalmori,$as_codalmdes,$as_obstra,$aa_seguridad,$ls_codtiend)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $ls_sql= "UPDATE sim_transferencia".
				  ...
				  " WHERE codemp='" . $as_codemp ."'".
				  "   AND numtra='" . $as_numtra ."'".
				  "   AND fecemi='" . $ad_fecemi ."' AND codtiend='".$ls_codtiend."'";
		$li_row = $this->io_sql->execute($ls_sql);
		if($li_row===false)
		{
...
function uf_sim_delete_transferencia($as_codemp,$as_numtra,$ad_fecemi,$aa_seguridad,$ls_codtiend)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function uf_sim_select_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$ls_codproveedor,$ls_codtiend)
	{
...
function uf_sim_insert_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$as_unidad,$ai_cantidad,$ai_cosuni,$ai_costot,$ls_codproveedor,$ls_codtiend)
	{

		$lb_valido=true;
		$ls_sql="INSERT INTO sim_dt_transferencia (codemp, numtra, fecemi, codart, unidad, cantidad, cosuni, costot,codtiend,cod_pro)".
				" VALUES ('".$as_codemp."','".$as_numtra."','".$ad_fecemi."','".$as_codart."','".$as_unidad."','".$ai_cantidad."',".
				"         '".$ai_cosuni."','".$ai_costot."','".$ls_codtiend."','".$ls_codproveedor."')";
...
function uf_sim_update_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$as_codunimed,$ai_cantidad,$ai_cosuni,$ai_costot,$ls_codproveedor,$ls_codtiend)
	{
...
function uf_sim_guardar_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$as_codunimed,$ai_cantidad,$ai_cosuni,$ai_costot,$aa_seguridad,$ls_codproveedor,$ls_codtiend)
	{

		if(!($this->uf_sim_select_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$ls_codproveedor,$ls_codtiend)))
		{
			$lb_valido=$this->uf_sim_insert_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$as_codunimed,$ai_cantidad,$ai_cosuni,$ai_costot,$ls_codproveedor,$ls_codtiend);
		}
		else
		{
			$lb_valido=$this->uf_sim_update_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$as_codunimed,$ai_cantidad,$ai_cosuni,$ai_costot,$ls_codproveedor,$ls_codtiend);
		}
		return $lb_valido;
	} // end function uf_sim_guardar_dt_transferencia

function uf_sim_delete_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$ls_codproveedor,$ls_codtiend)
	{
	//////////////////////////////////////////////////////////////////////////////
	...
	function uf_sim_obtener_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,&$ai_totrows,&$ao_object,$ls_codtiend)
	{
	//////////////////////////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="SELECT sim_dt_transferencia.*,sim_articulo.codunimed,sim_unidadmedida.unidad AS unidades,".
				...
				" (SELECT nompro from rpc_proveedor where sim_dt_transferencia.cod_pro=rpc_proveedor.cod_pro) AS nompro ".
				...
				"   AND sim_dt_transferencia.fecemi='". $ad_fecemi ."' AND codtiend='".$ls_codtiend."'";
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($li_exec))
			{
				    ...
				    $ls_denproveedor=$row["nompro"];
					$li_existencia=   $row["cantidad"];
					...
					$ao_object[$ai_totrows][2]="<input name=txtdenproveedor".$ai_totrows."   type=text id=txtdenproveedor".$ai_totrows."   class=sin-borde size=30 maxlength=35 value='".$ls_denproveedor."' ><input name=txtcodproveedor".$ai_totrows."   type=text id=txtcodproveedor".$ai_totrows."   class=sin-borde size=10 maxlength=12 value='".$ls_codproveedor."' >";
					...
					$ao_object[$ai_totrows][4]="<input name=txtcantidad".$ai_totrows." type=text id=txtcantidad".$ai_totrows." class=sin-borde size=14 maxlength=12 value='".number_format ($li_cantidad,2,",",".")."' onKeyUp='javascript: ue_validarnumero(this);'><input name=txtexistencia".$ai_totrows." type='hidden' id=txtexistencia".$ai_totrows." class=sin-borde size=10 maxlength=12 value='".$li_existencia."' >";
	...
	function uf_select_movimiento($ls_metodo,&$rs_metodo,$as_codart,$as_codalm,$ls_codproveedor,$ls_codtiend)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ls_metodo=="FIFO")
		{
			if($this->ls_gestor=="MYSQL")
			{
				$ls_sql="SELECT * FROM sim_dt_movimiento".
						...
						"   WHERE opeinv ='REV') AND codtiend='".$ls_codtiend."' AND cod_pro='".$ls_codproveedor."'".
						" ORDER BY nummov";
			}
			else
			{
	...
	function uf_sim_procesar_dt_movimientotransferencia($as_codemp,$as_nummov,$as_codart,$as_codalm,$as_unidad,$ai_canart,
	                                                    $ai_preuniart,$ad_fecemi,$as_numtra,$aa_seguridad,$ls_codproveedor,$ls_codtiend)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($lb_valido)
		{
			$lb_valido=$this->uf_select_movimiento($ls_metodo,$rs_metodo,$as_codart,$as_codalm,$ls_codproveedor,$ls_codtiend);
			if($lb_valido)
			{
				if($ls_metodo!="CPP")
				{
							...
							if ($li_existencia > 0)
							{
								...
								if ($li_existencia < $ai_canart)
								{
									...
									$lb_valido=$this->uf_sim_disminuir_articuloxmovimiento($as_codemp,$as_codart,$ls_codalm,$ls_nummov,
																							$ls_numdocori,$li_existencia,$ls_codproveedor,$ls_codtiend);
									if ($lb_valido)
									{
										$ls_opeinv="SAL";
										$ls_promov="TRA";
										...
										$lb_valido=$this->io_mov->uf_sim_insert_dt_movimiento($as_codemp,$as_nummov,$ad_fecemi,
																							  ...
																							  $as_numtra,$li_existencia,$li_preuniart,$ls_promov,
																						  	  $ls_numdocori,$li_candesart,$ad_fecemi,$aa_seguridad,
																						  	  $ls_codtiend,$ls_codproveedor);
								...
								{
									$lb_valido=$this->uf_sim_disminuir_articuloxmovimiento($as_codemp,$as_codart,$ls_codalm,$ls_nummov,
																							$ls_numdocori,$ai_canart,$ls_codproveedor,$ls_codtiend);
									if ($lb_valido)
									{
										$ls_opeinv="SAL";
										$ls_promov="TRA";
										...
										$lb_valido=$this->io_mov->uf_sim_insert_dt_movimiento($as_codemp,$as_nummov,$ad_fecemi,
																							  ...
																							  $as_numtra,$ai_canart,$li_preuniart,$ls_promov,
																						  	  $ls_numdocori,$li_candesart,$ad_fecemi,
																							  $aa_seguridad,$ls_codtiend,$ls_codproveedor);
