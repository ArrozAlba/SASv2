<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,$as_comprobante,$as_nomemp,$as_denfuefin,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],20,710,$_SESSION["ls_width"],$_SESSION["ls_height"]);
		$tm=306-($li_tm/2);
		$io_pdf->rectangle(20,690,570,80);
		$io_pdf->addText(160,750,9,"<b>ORGANO: ".$as_nomemp."</b>");
		$io_pdf->addText(465,730,8,"<b>PÁGINA N°.</b>");
		$io_pdf->addText(465,750,8,"<b>COD.</b> ".$as_comprobante);
		$io_pdf->addText(25,702,8,"FECHA: ".$ad_fecha);
		$io_pdf->addText(25,692,8,"FUENTE DE FINANCIAMIENTO: ".$as_denfuefin);
		//$io_pdf->addText(180,730,10,$as_titulo);
		$io_pdf->addText(186,730,9,$as_titulo);
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(200,102,8,"<b>EMPRESA</b>"); // Agregar el título
		$io_pdf->addText(418,102,8,"<b>OFICINA NACIONAL DE PRESUPUESTO</b>"); // Agregar el título

			
		$io_pdf->addText(22,90,6.5,"UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(101,90,7,"UNIDAD EJECUTORA"); // Agregar el título
		$io_pdf->addText(190,90,7,"OFICINA DE PLANIFICACION"); // Agregar el título
		$io_pdf->addText(203,83,7," Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(302,90,7,"APROBADO PRESIDENTE"); // Agregar el título
		//$io_pdf->addText(310,83,7,"PRESIDENTE"); // Agregar el título
		$io_pdf->addText(416,90,7,"JEFE SECTOR"); // Agregar el título
		$io_pdf->addText(491,90,7,"DIRECTOR G. SECTORIAL"); // Agregar el título
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	  ...
	  if ($lb_valido==false)
	   ...
	   else
		 {
			...
			$io_pdf->ezStartPageNumbers(540,730,8,'','',1); // Insertar el número de página
			$ls_titulo = "<b>SOLICITUD DE MODIFICACIÓN PRESUPUESTARIA</b>";			
			uf_print_encabezado_pagina($ls_titulo,$ls_procede,$ld_fecha,$ls_comprobante,$ls_nomemp,$ls_denfuefin,$io_pdf); // Imprimimos el encabezado de la página
