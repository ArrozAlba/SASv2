...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_fuente.php";
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-celdanew">Listado de Fuentes de Financiamiento </td>
    </tr>
  </table>
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			pagina="reportes/sigesp_spg_rpp_fuentes.php?codestpro1="+codestpro1
		...
		else
		{
			...
			pagina="reportes/sigesp_spg_rpp_fuentes.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
			...
			+"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas
			+"&estclades="+estclades+"&estclahas="+estclahas;
			window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}
