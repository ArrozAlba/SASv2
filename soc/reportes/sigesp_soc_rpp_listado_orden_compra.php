<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$rs_data = $io_report->uf_select_listado_orden_compra($ls_numordcomdes,$ls_estcondat,$ls_numordcomhas,$ls_codprodes,
                                                            $ls_codprohas,$ls_fecordcomdes,$ls_fecordcomhas,$ls_tipo,
															$ls_coduniadmdes,$ls_coduniadmhas,$ls_rdpre,$ls_rdcon,$ls_rdanu,
