<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$as_codproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,						
						 'cols'=>array('1'=>array('justification'=>'left','width'=>270),'2'=>array('justification'=>'left','width'=>200),
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'xPos'=>328,						
						 'cols'=>array('space'=>array('justification'=>'left','width'=>35),'data'=>array('justification'=>'left','width'=>400))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	
		//--------------------------------------------------------------------------------------------------------------
		
		$io_pdf->ezSetY(672);//670
		...
		$io_pdf->ezSetY(615);//618
		$la_data=array(array('1'=>' ','caduca'=>' ','3'=>' '),array('1'=>' ','caduca'=>' **  NO ENDOSABLE  **   **CADUCA A LOS 90 DIAS**','3'=>' '),array('1'=>' ','caduca'=>'                          ','3'=>' '),array('1'=>' ','caduca'=>' ','3'=>' '),array('1'=>' ','caduca'=>' ','3'=>' '));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'xPos'=>210,
						 'cols'=>array('1'=>array('justification'=>'left','width'=>380),'caduca'=>array('justification'=>'right','width'=>270),
