<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$as_codproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'fontSize' => 12, // Mostrar Líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xOrientation'=>'center', // Orientación de la tabla
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,						
						 'cols'=>array('1'=>array('justification'=>'left','width'=>190),'2'=>array('justification'=>'left','width'=>210),
						 'monto'=>array('justification'=>'left','width'=>100),'4'=>array('justification'=>'left','width'=>30))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'fontSize' => 11, // Mostrar Líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xOrientation'=>'center', // Orientación de la tabla
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,						
						 'cols'=>array('space'=>array('justification'=>'left','width'=>85),'data'=>array('justification'=>'left','width'=>420))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		
		//--------------------------------------------------------------------------------------------------------------
		
		$io_pdf->ezSetY(674);
		$la_data=array(array('space'=>'','data'=>$ls_fecha));
		$la_columna=array('space'=>'','data'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
		...
		$io_pdf->ezSetY(633);
		$la_data=array(array('1'=>' ','caduca'=>' ','3'=>' '),array('1'=>' ','caduca'=>'                      ***  NO ENDOSABLE  ***','3'=>' '),array('1'=>' ','caduca'=>'                          ','3'=>' '),array('1'=>' ','caduca'=>' ','3'=>' '),array('1'=>' ','caduca'=>' ','3'=>' '));
		$la_columna=array('1'=>' ','caduca'=>' ','3'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'shadeCol2'=>array(0.9,1.9,0.9), // Color de la sombra
						 'xOrientation'=>'center', // Orientación de la tabla
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'xPos'=>210,
						 'cols'=>array('1'=>array('justification'=>'left','width'=>190),'caduca'=>array('justification'=>'center','width'=>260),
						 '3'=>array('justification'=>'left','width'=>20))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_codproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('ordenes'=>'<b>Orden(es) de Pago(s):</b> '.$ls_solicitudes),
					   array('ordenes'=>'<b>Beneficiario:</b> '.$ls_nomproben."         Rif\Cédula::".$ls_codproben),
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$io_pdf->ezSetCmMargins(2,3.5,1,1); // Configuración de los margenes en centímetros	
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'titleFontSize' => 13,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'width'=>580, // Ancho de la tabla
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_nomina($la_title,$la_data,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle
		//		    Acess: private 
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>180),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>60),
									   'monto_spg_d'=>array('justification'=>'right','width'=>60),									   
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$la_data=array(array('nombre'=>'<b>Nombre:</b>  ','cedula'=>'<b>Cedula de Identidad:</b>  ','fecha'=>'<b>Fecha:</b>  ','firma'=>'<b>Firma / Sello :</b>  '),
	...
	$li_bsf=$_SESSION["la_empresa"]["codemp"];
	...
	if($li_bsf==1)	{ 	$numalet->setMoneda("Bolivares"); }
	else	        { 	$numalet->setMoneda("Bolivares");  }
	//cambia prefijo
	$numalet->setPrefijo("");
	//cambia sufijo
	$numalet->setSufijo("");
	...
	$io_pdf->ezSetCmMargins(-1,3.5,1,1); // Configuración de los margenes en centímetros
	...
	for($li_i=1;$li_i<=$li_totrow;$li_i++)
	{
		...
		$ls_nomproben	=trim($ds_voucher->data["nomproben"][$li_i]);
		$ls_tipproben	=$ds_voucher->data["tipo_destino"][$li_i];		
		$ls_rifpro  	=$ds_voucher->data["rifpro"][$li_i];
		
		if($ls_tipproben=="B")
		{
		     $ls_codproben	=$ds_voucher->data["ced_bene"][$li_i];		
		}
		if($ls_tipproben=="P")
		{ 
		    $ls_codproben	=$ls_rifpro;		
		}
		$ls_ciudad="BARQUISIMETO";
		...
		uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_codproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
		$io_pdf->ezStartPageNumbers(550,50,10,'','',1); // Insertar el número de página
		uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_codproben,$ls_solicitudes,$ls_conmov,$io_pdf); // Imprimimos la cabecera del registro
			...
			for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
			{
				...
				if(array_key_exists("spg_cuenta",$ds_dt_spg->data))
				{
					if(array_key_exists($li_s,$ds_dt_spg->data["spg_cuenta"]))
					{
						...
						$ls_estpro1     = substr($ls_estpro,0,20);
						$ls_estpro2     = substr($ls_estpro,21,6);
						$ls_estpro3     = substr($ls_estpro,28,3);
						$ls_denunieje   = $class_report->uf_load_unidad_ejecutora($ls_estpro1,$ls_estpro2,$ls_estpro3);
						$ls_estpro      = $ls_denunieje;
		...
		{// Hacemos un rollback de los registros, agregamos una nueva página y volvemos a imprimir
			...
			//$io_pdf->ezNewPage();
			uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_codproben,$ls_monto,$ls_ciudad.", ".$ld_fecmov,$io_pdf);
			uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_codproben,$ls_solicitudes,$ls_conmov,$io_pdf); // Imprimimos la cabecera del registro
