<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		if(array_key_exists(0,$la_arreglo))
			$io_pdf->add_texto($valores[4],$valores[5],8,"<b>$la_arreglo[0]</b>");
		if(array_key_exists(1,$la_arreglo))
			$io_pdf->add_texto($valores[6],$valores[7],8,"<b>$la_arreglo[1]</b>");
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->addText(273,137.6,9,'<b>Aprobado por:</b>');		
		$io_pdf->addText(384,137.6,9,'<b>Autorizado por:</b>');		
		$io_pdf->addText(508,137.6,9,'<b>Registrado por:</b>');
