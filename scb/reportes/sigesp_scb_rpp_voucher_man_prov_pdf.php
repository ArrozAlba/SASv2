<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$as_codproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,						
						 'cols'=>array('1'=>array('justification'=>'left','width'=>270),'2'=>array('justification'=>'left','width'=>180),
						 'monto'=>array('justification'=>'left','width'=>180),'4'=>array('justification'=>'left','width'=>30))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		//Imprimo los datos del cheque
		$ls_monto=$ls_monto." "."BOLIVARES ";
		$io_pdf->ezSetY(733);//742
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'fontSize' => 10, // Mostrar Líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xOrientation'=>'center', // Orientación de la tabla
						 'width'=>610, // Ancho de la tabla
						 'maxWidth'=>580,
						 'xPos'=>300,						
						 'cols'=>array('space'=>array('justification'=>'left','width'=>15),'data'=>array('justification'=>'left','width'=>400))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	
		//--------------------------------------------------------------------------------------------------------------
		
		$io_pdf->ezSetY(661);//670
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,						
						 'cols'=>array('space'=>array('justification'=>'left','width'=>40),'data'=>array('justification'=>'left','width'=>520))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$io_pdf->ezSetY(620);//618
		$la_data=array(array('1'=>' ','caduca'=>' ','3'=>' '),array('1'=>' ','caduca'=>' **  NO ENDOSABLE  **   **CADUCA A LOS 45 DIAS**','3'=>' '),array('1'=>' ','caduca'=>'                          ','3'=>' '),array('1'=>' ','caduca'=>' ','3'=>' '),array('1'=>' ','caduca'=>' ','3'=>' '));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>540,
						 'xPos'=>190,
						 'cols'=>array('1'=>array('justification'=>'left','width'=>260),'caduca'=>array('justification'=>'left','width'=>270),
	...
	if($li_bsf==1)	{ 	$numalet->setMoneda(""); }
	else	        { 	$numalet->setMoneda("");  }
	//cambia prefijo
	$numalet->setPrefijo("");
	//cambia sufijo
	$numalet->setSufijo("");
	...
	for($li_i=1;$li_i<=$li_totrow;$li_i++)
	{
		...
		uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_codproben,$ls_monto,$ls_ciudad.", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
