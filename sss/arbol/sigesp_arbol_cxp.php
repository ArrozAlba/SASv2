...
$arbol["sistema"][$li_i]="CXP";
$arbol["nivel"][$li_i]=1;
$arbol["nombre_logico"][$li_i]="Reportes - Retenciones (1 Por Mil)";
$arbol["nombre_fisico"][$li_i]="sigesp_cxp_r_retunoxmil.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="005";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["sistema"][$li_i]="CXP";
$arbol["nivel"][$li_i]=1;
$arbol["nombre_logico"][$li_i]="Reportes - Comprobantes de Retencion I.V.A";
$arbol["nombre_fisico"][$li_i]="sigesp_cxp_r_comp_ret_iva.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="005";
$arbol["numero_hijos"][$li_i]=0;
