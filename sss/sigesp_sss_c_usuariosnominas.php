...
class sigesp_sss_c_usuariosnominas
{
	...
	function  uf_sss_select_grupo_nomina($as_codemp,$as_codnom,$as_codgru)
	{
		...
		//	      Returns: Retorna un Booleano
		//    Description: Función que se encarga de verificar si una nomina existe para un determinado grupo
		//	   Creado Por: Ing. Nelson Barraez
		// Fecha Creación: 03/06/2010								Fecha Última Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_select_grupo_nomina ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
	...
	function  uf_sss_load_nominasdisponibles($as_codemp,$as_codusugrup,&$aa_disponibles,$as_usugrup)
	{
		...
		//	      Returns: Retorna un Booleano
		//    Description: Función que carga los datos de las nominas que estan disponibles para un determinado usuario o grupo
		//	   Creado Por: Ing. Luis Anibal Lang
		// Fecha Creación: 26/10/2006				Fecha Última Modificación : 03/06/2010 Por: Ing. Nelson Barraez
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
		if($as_usugrup=='U')
		{
	...
	function  uf_sss_load_nominasasignadas($as_codemp,$as_codusugrup,&$aa_asignados,$as_usugrup)
	{
		...
		//				   $as_usugrup    //Indica si es usuario o grupo
		//	      Returns: Retorna un Booleano
		//    Description: Función que carga los datos de las nominas que estan asignados para un determinado usuario o grupo
		//	   Creado Por: Ing. Luis Anibal Lang
		// Fecha Creación: 26/10/2006			Fecha Última Modificación : 03/06/2010 Por : Ing. Nelson Barraez
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
	...
	function  uf_sss_insert_grupo_nomina($as_codemp,$as_codnom,$as_codgru,$aa_seguridad)
	{
		...
		//	   Creado Por: Ing. Nelson Barraez
		// Fecha Creación: 03/06/2006									Fecha Última Modificación :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_insert_grupo_nomina ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$lb_valido=true;
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="INSERT";
			$ls_descripcion ="Relacionó la Nomina ".$as_codnom." al grupo ".$as_codgru." Asociado a la empresa ".$as_codemp;
			$lb_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	function uf_sss_delete_grupo_nomina($as_codemp,$as_codnom,$as_codgru,$aa_seguridad)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_delete_grupo_nomina ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
			$ls_evento="DELETE";
			$ls_descripcion ="Eliminó la Nomina ".$as_codnom." al grupo ".$as_codgru." Asociado a la empresa ".$as_codemp;
			$lb_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////			
