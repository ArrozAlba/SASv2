 ...
 *
 * @category
 * @package     Models ExamenesMedicos
 * @subpackage
 * @author      alexis borges
 * @copyright    
 */
class ExamenesMedicos extends ActiveRecord {
     ...
     * @return Sucursal
     */
    public function getInformacionExamenesMedicos($id, $isSlug=false) {
     ...
     * @return ActiveRecord
     */
    public function getListadoExamenesMedicos($order='order.descripcion.asc', $page='', $empresa=null) {
     ...
     * @return Obj
     */
    public static function setExamenesMedicos($method, $data, $optData=null) {
        //Se aplica la autocarga
        $obj = new ExamenesMedicos($data);
