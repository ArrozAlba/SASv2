 ...
 *
 * @category
 * @package     Models Funeraria
 * @subpackage
 * @author      alexis borges
 * @copyright    
 */
class Funeraria extends ActiveRecord {
     ...
     * @return Sucursal
     */
    public function getInformacionFuneraria($id, $isSlug=false) {
     ...
     * @return ActiveRecord
     */
    public function getListadoFuneraria($order='order.descripcion.asc', $page='', $empresa=null) {
     ...
     * @return Obj
     */
    public static function setFuneraria($method, $data, $optData=null) {
        //Se aplica la autocarga
        $obj = new Funeraria($data);
