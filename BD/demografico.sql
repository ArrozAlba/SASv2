...
COMMENT ON TABLE sas_pais IS 'Country';


--
-- Name: COLUMN sas_pais.address_format; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_pais.address_format IS 'Address Format';


--
-- Name: COLUMN sas_pais.code; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_pais.code IS 'Country Code';


--
-- Name: COLUMN sas_pais.name; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_pais.name IS 'Country Name';
...
COMMENT ON TABLE sas_pais_estado IS 'Country state';


--
-- Name: COLUMN sas_pais_estado.code; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_pais_estado.code IS 'State Code';


--
-- Name: COLUMN sas_pais_estado.country_id; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_pais_estado.country_id IS 'Country';


--
-- Name: COLUMN sas_pais_estado.name; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_pais_estado.name IS 'State Name';
...
--
-- Name: COLUMN sas_ciudad.state_id; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_ciudad.state_id IS 'Estado';


--
-- Name: COLUMN sas_ciudad.code; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_ciudad.code IS 'Codigo de Ciudad';


--
-- Name: COLUMN sas_ciudad.name; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_ciudad.name IS 'Nombre de Ciudad';
...
--
-- Name: COLUMN sas_municipio.state_id; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_municipio.state_id IS 'Estado';


--
-- Name: COLUMN sas_municipio.code; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_municipio.code IS 'Codigo Municipio';


--
-- Name: COLUMN sas_municipio.name; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_municipio.name IS 'Nombre Municipio';
...
--
-- Name: COLUMN sas_parroquia.name; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_parroquia.name IS 'Parroquia';


--
-- Name: COLUMN sas_parroquia.municipalities_id; Type: COMMENT; Schema: public; Owner: jelitox
--

COMMENT ON COLUMN sas_parroquia.municipalities_id IS 'Municipio';
...
COPY sas_pais (id, create_uid, create_date, write_date, write_uid, address_format, code, name) FROM stdin;
1	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AD	Andorra, Principality of
2	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AE	United Arab Emirates
3	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AF	Afghanistan, Islamic State of
4	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AG	Antigua and Barbuda
5	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AI	Anguilla
6	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AL	Albania
7	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AM	Armenia
8	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AN	Netherlands Antilles
9	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AO	Angola
10	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AQ	Antarctica
11	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AR	Argentina
12	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AS	American Samoa
13	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AT	Austria
14	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s %(state_code)s %(zip)s\n%(country_name)s	AU	Australia
15	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AW	Aruba
16	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AX	Åland Islands
17	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	AZ	Azerbaijan
18	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BA	Bosnia-Herzegovina
19	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BB	Barbados
20	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BD	Bangladesh
21	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(zip)s, %(city)s\n%(country_name)s	BE	Belgium
22	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BF	Burkina Faso
23	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BG	Bulgaria
24	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BH	Bahrain
25	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BI	Burundi
26	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BJ	Benin
27	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BL	Saint Barthélémy
28	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BM	Bermuda
29	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BN	Brunei Darussalam
30	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BO	Bolivia
31	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BQ	Bonaire, Sint Eustatius and Saba
32	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s%(country_name)s	BR	Brazil
33	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BS	Bahamas
34	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BT	Bhutan
35	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BV	Bouvet Island
36	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BW	Botswana
37	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BY	Belarus
38	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	BZ	Belize
39	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s, %(state_code)s %(zip)s\n%(country_name)s	CA	Canada
40	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CC	Cocos (Keeling) Islands
41	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CF	Central African Republic
42	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CD	Congo, Democratic Republic of the
43	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CG	Congo
44	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CH	Switzerland
45	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CI	Ivory Coast (Cote D'Ivoire)
46	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CK	Cook Islands
47	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CL	Chile
48	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CM	Cameroon
49	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CN	China
50	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CO	Colombia
51	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CR	Costa Rica
52	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CU	Cuba
53	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CV	Cape Verde
54	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CW	Curaçao
55	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CX	Christmas Island
56	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CY	Cyprus
57	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	CZ	Czech Republic
58	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(zip)s %(city)s\n%(country_name)s	DE	Germany
59	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	DJ	Djibouti
60	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	DK	Denmark
61	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	DM	Dominica
62	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	DO	Dominican Republic
63	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	DZ	Algeria
64	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	EC	Ecuador
65	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	EE	Estonia
66	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	EG	Egypt
67	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	EH	Western Sahara
68	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ER	Eritrea
69	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(zip)s %(city)s,%(state_name)s\n%(country_name)s	ES	Spain
70	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ET	Ethiopia
71	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	FI	Finland
72	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	FJ	Fiji
73	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	FK	Falkland Islands
74	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	FM	Micronesia
75	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	FO	Faroe Islands
76	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(zip)s %(city)s\n%(country_name)s	FR	France
77	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GA	Gabon
78	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GD	Grenada
79	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GE	Georgia
80	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GF	French Guyana
81	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GH	Ghana
82	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GI	Gibraltar
83	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GG	Guernsey
84	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GL	Greenland
85	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GM	Gambia
86	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GN	Guinea
87	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GP	Guadeloupe (French)
88	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GQ	Equatorial Guinea
89	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GR	Greece
90	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GS	South Georgia and the South Sandwich Islands
91	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GT	Guatemala
92	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GU	Guam (USA)
93	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GW	Guinea Bissau
94	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	GY	Guyana
95	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	HK	Hong Kong
96	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	HM	Heard and McDonald Islands
97	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	HN	Honduras
98	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	HR	Croatia
99	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	HT	Haiti
100	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	HU	Hungary
101	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ID	Indonesia
102	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	IE	Ireland
103	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	IL	Israel
104	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	IM	Isle of Man
105	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s, %(zip)s\n%(state_name)s%(country_name)s	IN	India
106	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	IO	British Indian Ocean Territory
107	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	IQ	Iraq
108	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	IR	Iran
109	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	IS	Iceland
110	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	IT	Italy
111	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	JE	Jersey
112	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	JM	Jamaica
113	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	JO	Jordan
114	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	JP	Japan
115	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KE	Kenya
116	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KG	Kyrgyz Republic (Kyrgyzstan)
117	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KH	Cambodia, Kingdom of
118	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KI	Kiribati
119	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KM	Comoros
120	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KN	Saint Kitts & Nevis Anguilla
121	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KP	North Korea
122	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KR	South Korea
123	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KW	Kuwait
124	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KY	Cayman Islands
125	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	KZ	Kazakhstan
126	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LA	Laos
127	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LB	Lebanon
128	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LC	Saint Lucia
129	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LI	Liechtenstein
130	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LK	Sri Lanka
131	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LR	Liberia
132	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LS	Lesotho
133	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LT	Lithuania
134	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LU	Luxembourg
135	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LV	Latvia
136	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	LY	Libya
137	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MA	Morocco
138	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MC	Monaco
139	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MD	Moldavia
140	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ME	Montenegro
141	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MF	Saint Martin (French part)
142	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MG	Madagascar
143	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MH	Marshall Islands
144	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MK	Macedonia, the former Yugoslav Republic of
145	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ML	Mali
146	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MM	Myanmar
147	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MN	Mongolia
148	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MO	Macau
149	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MP	Northern Mariana Islands
150	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MQ	Martinique (French)
151	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MR	Mauritania
152	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MS	Montserrat
153	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MT	Malta
154	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MU	Mauritius
155	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MV	Maldives
156	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MW	Malawi
157	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MX	Mexico
158	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MY	Malaysia
159	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	MZ	Mozambique
160	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NA	Namibia
161	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NC	New Caledonia (French)
162	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NE	Niger
163	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NF	Norfolk Island
164	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NG	Nigeria
165	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NI	Nicaragua
166	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(zip)s %(city)s\n%(country_name)s	NL	Netherlands
167	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NO	Norway
168	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NP	Nepal
169	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NR	Nauru
170	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NT	Neutral Zone
171	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NU	Niue
172	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	NZ	New Zealand
173	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	OM	Oman
174	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PA	Panama
175	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PE	Peru
176	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PF	Polynesia (French)
177	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PG	Papua New Guinea
178	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PH	Philippines
179	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PK	Pakistan
180	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PL	Poland
181	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PM	Saint Pierre and Miquelon
182	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PN	Pitcairn Island
183	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PR	Puerto Rico
184	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PS	Palestinian Territory, Occupied
185	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PT	Portugal
186	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PW	Palau
187	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	PY	Paraguay
188	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	QA	Qatar
189	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	RE	Reunion (French)
190	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	RO	Romania
191	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	RS	Serbia
192	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	RU	Russian Federation
193	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	RW	Rwanda
194	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SA	Saudi Arabia
195	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SB	Solomon Islands
196	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SC	Seychelles
197	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SD	Sudan
198	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SE	Sweden
199	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SG	Singapore
200	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SH	Saint Helena
201	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SI	Slovenia
202	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SJ	Svalbard and Jan Mayen Islands
203	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SK	Slovakia
204	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SL	Sierra Leone
205	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SM	San Marino
206	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SN	Senegal
207	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SO	Somalia
208	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SR	Suriname
209	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SS	South Sudan
210	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ST	Saint Tome (Sao Tome) and Principe
211	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SV	El Salvador
212	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SX	Sint Maarten (Dutch part)
213	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SY	Syria
214	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	SZ	Swaziland
215	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TC	Turks and Caicos Islands
216	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TD	Chad
217	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TF	French Southern Territories
218	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TG	Togo
219	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TH	Thailand
220	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TJ	Tajikistan
221	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TK	Tokelau
222	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TM	Turkmenistan
223	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TN	Tunisia
224	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TO	Tonga
225	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TP	East Timor
226	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TR	Turkey
227	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TT	Trinidad and Tobago
228	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TV	Tuvalu
229	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TW	Taiwan
230	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	TZ	Tanzania
231	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	UA	Ukraine
232	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	UG	Uganda
233	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s\n%(country_name)s\n%(zip)s	GB	United Kingdom
234	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	UM	USA Minor Outlying Islands
235	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s, %(state_code)s %(zip)s\n%(country_name)s	US	United States
236	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	UY	Uruguay
237	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	UZ	Uzbekistan
238	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	VA	Holy See (Vatican City State)
239	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	VC	Saint Vincent & Grenadines
240	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	VE	Venezuela
241	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	VG	Virgin Islands (British)
242	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	VI	Virgin Islands (USA)
243	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	VN	Vietnam
244	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	VU	Vanuatu
245	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	WF	Wallis and Futuna Islands
246	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	WS	Samoa
247	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	YE	Yemen
248	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	YT	Mayotte
249	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	YU	Yugoslavia
250	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ZA	South Africa
251	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ZM	Zambia
252	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ZR	Zaire
253	1	2014-01-26 04:36:17.418381	\N	\N	%(street)s\n%(street2)s\n%(city)s,%(state_code)s %(zip)s\n%(country_name)s	ZW	Zimbabwe
\.
...
COPY sas_pais_estado (id, create_uid, create_date, write_date, write_uid, code, country_id, name) FROM stdin;
...
COPY sas_ciudad (id, create_uid, create_date, write_date, write_uid, state_id, code, name) FROM stdin;
...
COPY sas_municipio (id, create_uid, create_date, write_date, write_uid, state_id, code, name) FROM stdin;
...
COPY sas_parroquia (id, create_uid, create_date, write_date, write_uid, name, municipalities_id) FROM stdin;
...
--
-- Name: sas_pais_code_uniq; Type: CONSTRAINT; Schema: public; Owner: jelitox; Tablespace: 
--

ALTER TABLE ONLY sas_pais
    ADD CONSTRAINT sas_pais_codigo_unico UNIQUE (code);
...
ALTER TABLE ONLY sas_pais
    ADD CONSTRAINT sas_pais_nombre_unico UNIQUE (name);
...
--
-- Name: sas_ciudad_state_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jelitox
--

ALTER TABLE ONLY sas_ciudad
    ADD CONSTRAINT sas_ciudad_state_id_fkey FOREIGN KEY (state_id) REFERENCES sas_pais_estado(id) ON DELETE SET NULL;

--
-- Name: sas_municipio_state_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jelitox
--

ALTER TABLE ONLY sas_municipio
    ADD CONSTRAINT sas_municipio_state_id_fkey FOREIGN KEY (state_id) REFERENCES sas_pais_estado(id) ON DELETE SET NULL;

--
-- Name: sas_parroquia_municipalities_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jelitox
--

ALTER TABLE ONLY sas_parroquia
    ADD CONSTRAINT sas_parroquia_municipio_id_fkey FOREIGN KEY (municipalities_id) REFERENCES sas_municipio(id) ON DELETE SET NULL;
