...
COMMENT ON TABLE sas_pais IS 'Pais';
...
COMMENT ON TABLE sas_pais_estado IS 'Pais Estado';
...
COPY sas_pais (id, creacion_uid, creacion_fecha, edicion_fecha, edicion_uid, address_format, codigo, nombre) FROM stdin;
