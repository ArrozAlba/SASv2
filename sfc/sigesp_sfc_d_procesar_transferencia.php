...
<html>
<head>
<title>Definici&oacute;n de Procesar Archivo de Transferencia</title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td width="499" height="20" class="cd-menu"><span class="descripcion_sistema Estilo1 Estilo3">Sistema de Facturaci&oacute;n</span></td>
      ...
      <tr>
        <td width="516" height="195"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            <tr>
              <td colspan="2" class="titulo-ventana">Procesar Archivo de Transferencia  </td>
            </tr>
            <tr>
              <td >
			...
			<tr>
			  <td height="22" align="right">Archivo</td>
			  <td ><label>
            ...
            <tr>
              <td height="8" colspan="2"><table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                <tr>
                  <td height="17" colspan="3" align="right" class="titulo-ventana">Resumen Productos </td>
                </tr>
                <tr>
				...
				<tr>
					<td width="92" height="17" align="center" class="titulo-ventana">C&oacute;digo</td>
					<td width="223" height="17" align="center" class="titulo-ventana">Descripci&oacute;n</td>
			        <td width="98" align="center" class="titulo-ventana">Cantidad</td>
				</tr>
				<?PHP
/************************************************************************************************************************/
/***************************   PROCESAR ********************************************************************************/
...
/*********************************************************************************************************************************/
                ...
                <tr>
                  <td height="26" align="center" style="">&nbsp;</td>
                  <td height="26" align="center" td>&nbsp;</td>
                  <td height="26" align="center" td>&nbsp;</td>
                </tr>
                <tr>
...
function ue_procesar()
{
  ...
  f.action="sigesp_sfc_d_procesar_transferencia.php";
  f.submit();
