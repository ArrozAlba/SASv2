...
<html>
<head>
<title>REPORTE DETALLADO DE COBROS</title>
  ...
  <td width="582" height="100" align="center" >
   ...
   <table width="560" height="150" border="0" cellpadding="0" cellspacing="0" class="contorno">
               <tr class="titulo-celdanew">
                 <td width="500" height="22" class="titulo-celdanew">Reporte de Detallado de Cobros</td>
               </tr>
	...
	<tr>
	 ...
	 <table width="530"  height="100"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                   ...
                   <?php
					...
					<tr>
		                <td width="150" height="28" align="right">Cliente:</td>
		                <td colspan="3" >

		                <input name="txtrazcli" type="text" id="txtrazcli" size="50" value="">
                   ...
                   <tr>
                       <td height="28" align="right">Factura:</td>
                       <td colspan="3"><input name="txtfactura" type="text" id="txtfactura" size="50" value=""></td>
                   </tr>
                   <tr>
                       <td height="28" align="right">Cobro:</td>
                       <td colspan="3"><input name="txtcobro" type="text" id="txtcobro" size="50" value=""></td>
                   </tr>
                     <tr>
        ...
        <input name="txtcodtie" type="hidden" id="txtcodtie" size="15" value="<? print $ls_codtie ?>">
       	...
       	<tr align="right">
		               ...
		               <a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" width="20" height="20" border="0"></a>
...
function ue_openexcel()
{
	...
	if(li_imprimir==1) {
        ...
        ld_desde=f.txtdesde.value;
        ld_hasta=f.txthasta.value;
        ld_razcli = f.txtrazcli.value;
        ld_fact = f.txtfactura.value;
        ld_cobro = f.txtcobro.value;



		if (ld_desde=='' && ld_hasta=='')
	{
		pagina="reportes/sigesp_sfc_rep_relacion_cobros_factura_inspago_excel.php?desde="+ld_desde+"&hasta="+ld_hasta+"&razcli="+ld_razcli+"&factura="+ld_fact+"&cobro="+ld_cobro;
                window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	}
	else
	{       
                if (ld_desde=='')
                {
                 alert("Debe selecionar una Fecha Desde");    
                }else {
		if (ld_hasta=='')
		{
		alert("Debe selecionar una Fecha hasta");
		}
		else
		{
			valido=ue_comparar_intervalo();
