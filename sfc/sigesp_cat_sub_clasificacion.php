			...
			else
			{
				if($row=$io_sql->fetch_row($rs_datauni))
				{
					...
					for($z=1;$z<=$totrow;$z++)
					{
						...
						print "<td><a href=\"javascript: aceptar('$codsub','$nomsub','$codcla','$nomcla1');\">".$nomsub."</a>
						</td>";
...
<script language="JavaScript">
  ...
  function aceptar(codsub,nomsub,codcla,nomcla1)
  {
    opener.ue_cargarsubclasificacion(codsub,nomsub,codcla,nomcla1);
	close();
  }
