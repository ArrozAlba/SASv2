...
else
{
	...
	$ls_codcli="";
	$ls_razcli="";
	$ld_fecemi=date("01/m/Y");
	$ld_fecemi2=date("d/m/Y");
	$ls_orden="";
	$ls_ordenarpor="Null";
}
?>
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
    <table width="601" height="260" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td width="599" height="258"><div align="center">
            <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
              ...
              <tr>
                ...
                Orden</p>				</td>
                <td width="186" ><select name="combo_orden" size="1">
                  <?php
				  if ($ls_orden=="ASC")
				   {
				   ?>
			...
			<?php
              ...
              <tr>
                ...
                <td colspan="2"><input name="txtfecemi" type="text" id="txtfecemi"  style="text-align:left" onKeyPress="javascript:ue_validafecha();" value="<?php print $ld_fecemi?>" size="11" maxlength="10" readonly="true"  datepicker="true"></td>
              </tr>
              <tr align="left">
                <td height="23" align="right">Fecha hasta </td>
                <td colspan="2"><input name="txtfecemi2" type="text" id="txtfecemi2"  style="text-align:left" onKeyPress="javascript:ue_validafecha();" value="<?php print $ld_fecemi2?>" size="11" maxlength="10" readonly="true"  datepicker="true"></td>
              </tr>
              <tr>
                <td height="8"><div align="right">Monto Cobrado </div></td>
                <td colspan="2"><input name="monto" type="text" id="monto" onKeyPress="return(currencyFormat(this,'.',',',event))">
                  -
                <input name="monto2" type="text" id="monto2" onKeyPress="return(currencyFormat(this,'.',',',event))"></td>
              </tr>
              <tr>
                <td height="8">&nbsp;</td>
                <td colspan="2">&nbsp;</td>
...
/*if(li_imprimir==1)
{
  ...
  f.submit();
	...
	var ls_fecemi=f.txtfecemi.value;
	var ls_fecemi2=f.txtfecemi2.value;
	var ld_monto=f.monto.value;
	var ld_monto2=f.monto2.value;	
	var ls_orden=f.combo_orden.value;
	var ls_ordenarpor=f.combo_ordenarpor.value;
	   	//pagina="../sfc/reportes/documentos/sigesp_sfc_rep_cuentasxcobrar.php";
		pagina="reportes/sigesp_sfc_rep_resumencuentasxcobrar.php?fecemi2="+ls_fecemi2+"&fecemi="+ls_fecemi+"&monto="+ld_monto+"&monto2="+ld_monto2;
	  	popupWin(pagina,"catalogo",580,700);
}
