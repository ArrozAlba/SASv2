...
class sigesp_sim_c_transferencia_transf
{
	...
	function uf_sim_select_transferencia($as_codemp,$as_numtra,$ad_fecemi)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_select_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_insert_transferencia_transf($as_codemp,&$as_numtra,$ad_fecemi,$as_codusu,$as_codalmori,$as_codalmdes,$as_obstra,$aa_seguridad)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_insert_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_update_transferencia($as_codemp,&$as_numtra,$ad_fecemi,$as_codusu,$as_codalmori,$as_codalmdes,$as_obstra,$aa_seguridad)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_update_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_delete_transferencia($as_codemp,$as_numtra,$ad_fecemi,$aa_seguridad)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_delete_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_select_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_select_dt_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_insert_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$as_unidad,$ai_cantidad,$ai_cosuni,$ai_costot)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_insert_dt_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_update_dt_transferencia($as_codemp,$as_numtra,$ad_fecemi,$as_codart,$as_codunimed,$ai_cantidad,$ai_cosuni,$ai_costot)
	{
		...
		{
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_update_dt_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	//////////////////////////////////////////////////////////////////////////////		
		...
		if($li_exec==false)
		{
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_delete_dt_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	//////////////////////////////////////////////////////////////////////////////		
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_obtener_dt_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$ai_totrows=0;
	...
	function uf_sim_disminuir_articuloxmovimiento($as_codemp,$as_codart,$as_codalm,$as_nummov,$ls_numdocori,$ai_cantidad)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->transferencia MÉTODO->uf_sim_disminuir_articuloxmovimiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
