...
function sigesp_sfc_c_rubro()
{
	...
	function uf_select_rubro($ls_codrubro)
	{
	    //////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_cadena="SELECT * FROM sfc_rubro
		            WHERE id_rubro='".$ls_codrubro."'";
		$rs_datauni=$this->io_sql->select($ls_cadena);

		if($rs_datauni==false)
		{
			$lb_valido=false;
			$this->io_msgc="Error SELEC en uf_select_uso ".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
...
function uf_select_rubro2($ls_codrubro,$ls_codrubromac)
	{
	    //////////////////////////////////////////////////////////////////////////////////////////
		// Function:    - uf_select_unidad
		// Parameters:  - $ls_codtob( Codigo del Tipo de Obra).
	    ...
	    $ls_codemp=$this->datoemp["codemp"];
		$ls_cadena="SELECT * FROM sfc_rubro
		            WHERE id_rubro='".$ls_codrubro."' or cod_rubro='".$ls_codrubromac."'";
		$rs_datauni=$this->io_sql->select($ls_cadena);
	...
	function uf_guardar_rubro($ls_codrubro,$ls_codrubromac,$ls_nomrubro,$ls_codciclo,$ls_codciclomac,$ls_codrenglon,$ls_codrenglonmac,$aa_seguridad)
	{
		//////////////////////////////////////////////////////////////////////////////////////////
		...
		//////////////////////////////////////////////////////////////////////////////////////////
		$ls_codemp=$this->datoemp["codemp"];
		$lb_existe=$this->uf_select_rubro2($ls_codrubro,$ls_codrubromac);

		if(!$lb_existe)
		{
            $ls_cadena= " INSERT INTO sfc_rubro(cod_rubro,codemp,denominacion,id_ciclo,cod_ciclo,id_renglon,cod_renglon)
			              VALUES ('".$ls_codrubromac."','".$ls_codemp."','".$ls_nomrubro."','".$ls_codciclo."','".$ls_codciclomac."','".$ls_codrenglon."','".$ls_codrenglonmac."') ";
		...
		{
			$ls_cadena= "UPDATE sfc_rubro
			             SET cod_rubro='".$ls_codrubromac."',denominacion='".$ls_nomrubro."',id_ciclo='".$ls_codciclo."',cod_ciclo='".$ls_codciclomac."',id_renglon='".$ls_codrenglon."',cod_renglon='".$ls_codrenglonmac."',codemp='".$ls_codemp."' WHERE id_rubro='".$ls_codrubro."'";
		...
		else
		{
			if($li_numrows>0)
			{
				...
				if($ls_evento=="INSERT")
				{
					/////////////////////////////////         SEGURIDAD               /////////////////////////////
					$ls_evento="INSERT";
					$ls_descripcion ="Insert� el Rubro ".$ls_codrubromac." ".$ls_nomrubro." Asociado a la Empresa ".$ls_codemp;
				...
				else
				{
					/////////////////////////////////         SEGURIDAD               /////////////////////////////
					$ls_evento="UPDATE";
					$ls_descripcion ="Actualiz� el Rubro ".$ls_codrubromac." ".$ls_nomrubro." Asociado a la Empresa ".$ls_codemp;
					$lb_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
													$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
													$aa_seguridad["ventanas"],$ls_descripcion);
					/////////////////////////////////         SEGURIDAD               /////////////////////////////
	...
	function uf_delete_rubro($ls_codrubro,$aa_seguridad)
	{
		//////////////////////////////////////////////////////////////////////////////////////////
		...
		$lb_valido=false;
		$ls_codemp=$this->datoemp["codemp"];
		$lb_existe=$this->uf_select_rubro($ls_codrubro);

		if($lb_existe)
		{
		    	$ls_cadena= " DELETE FROM sfc_rubro
							  WHERE id_rubro='".$ls_codrubro."'";
				...
				else
				{
					if($li_numrows>0)
					{
						...
						////////////////////////////////         SEGURIDAD               /////////////////////////////
						$ls_evento="DELETE";
						$ls_descripcion ="Elimin� el Rubro ".$ls_codrubro." ".$ls_nomrubro." Asociado a la Empresa ".$ls_codemp;
						$lb_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
														$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
														$aa_seguridad["ventanas"],$ls_descripcion);
						/////////////////////////////////         SEGURIDAD               ////////////////////////////
