...
class sigesp_sim_c_revtransferencia_transf
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function sigesp_sim_c_revtransferencia_transf()
	{
	...
	function uf_sim_select_transferencia($as_codemp,$as_numtra,&$as_codalmori,&$as_codalmdes)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->revtransferencia MÉTODO->uf_sim_select_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_select_dt_transferencia($as_codemp,$as_numtra,&$rs_data)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->revtransferencia MÉTODO->uf_sim_select_dt_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$lb_valido=true;
	...
	function uf_sim_load_transferencia(&$ai_totrows,&$ao_object)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->revtransferencia MÉTODO->uf_sim_load_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_i=0;
	...
	function uf_sim_update_articulos_transf($as_codemp,$as_numtra,$as_codalmori,$as_codalmdes,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_art=  new sigesp_sim_c_articuloxalmacen_transf();
		...
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$lb_valido2=$io_art->uf_sim_disminuir_articuloxalmacen_transf($as_codemp,$ls_codart,$as_codalmdes,$li_canart,$aa_seguridad);
				$io_archivo->uf_sim_disminuir_articuloxalmacen2_transf($as_codemp,$ls_codart,$as_codalmdes,$li_canart,$aa_seguridad);
				if($lb_valido2)
				{
					$lb_valido2=$io_art->uf_sim_aumentar_articuloxalmacen_transf($as_codemp,$ls_codart,$as_codalmori,$li_canart,$aa_seguridad);
					$io_archivo->uf_sim_sumar_articuloxalmacen2_transf($as_codemp,$ls_codart,$as_codalmori,$li_canart,$aa_seguridad);
	...
	function uf_sim_crear_movimientos($as_codemp,$ad_fecrev,$as_codalmori,$as_codalmdes,$as_opeinv,$as_codprodoc,$as_numtra,$as_promov,$ai_candesart,$as_codusu,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_nomsol="Reverso";
		$ls_nummov="";
		$lb_valido=$this->io_mov->uf_sim_insert_movimiento($ls_nummov,$ad_fecrev,$ls_nomsol,$as_codusu,$aa_seguridad);
		if ($lb_valido)
		{
			$lb_valido=$this->uf_sim_select_dt_transferencia($as_codemp,$as_numtra,$rs_data);
			if($lb_valido)
			{
				while($row=$this->io_sql->fetch_row($rs_data))
				{
	...
	function uf_sim_delete_dt_transferencia($as_codemp,$as_numtra)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->revtransferencia MÉTODO->uf_sim_delete_dt_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_delete_transferencia($as_codemp,$as_numtra)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->revtransferencia MÉTODO->uf_sim_delete_transferencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_sim_disminuir_articuloxmovimiento($as_codemp,$as_codart,$as_codalm,$as_numtra)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $rs_disart=-1;
		 $ld_date= date("Y-m-d");
		 $ls_sql = "UPDATE sim_dt_movimiento SET   candesart=0.00, ".
		 			" fecdesart= '" . $ld_date ."'".
					" WHERE codemp='" . $as_codemp ."'".
					" AND opeinv='ENT'".
					" AND codprodoc='ALM'".
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->revtransferencia MÉTODO->uf_sim_disminuir_articuloxmovimiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
