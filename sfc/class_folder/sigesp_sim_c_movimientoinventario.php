...
class sigesp_sim_c_movimientoinventario
{
	...
	function uf_sim_insert_movimiento($ls_codemp,&$as_nummov,$ad_fecmov,$as_nomsol,$as_codusu,$ls_codtie,$aa_seguridad)
	{
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="INSERT INTO sim_movimiento ( codemp,nummov, fecmov, nomsol, codusu, codtiend)".
				" VALUES ('".$ls_codemp."','".$as_nummov."','".$ad_fecmov."','".$as_nomsol."','".$as_codusu."','".$ls_codtie."')";
//print $ls_sql;
		...
		else
		{
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� el Movimiento ".$as_nummov." de Fecha ".$ad_fecmov." Asociado a la empresa ".$ls_codemp." de la Tienda ".$ls_codtie." ".$ls_nomtie;
	...
	function uf_sim_insert_dt_movimiento($as_codemp,$as_nummov,$ad_fecmov,$as_codart,$as_codalm,$as_opeinv,$as_codprodoc,$as_numdoc,
										 $ai_canart,$ai_cosart,$as_promov,$as_numdocori,$ai_candesart,$ad_fecdesart,$as_codproveedor,$ls_codtie,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sim_insert_movimiento
		//         Access: public
		...
		$ls_sql="INSERT INTO sim_dt_movimiento (codemp,nummov,fecmov,codart,codalm,opeinv,codprodoc,numdoc,canart,cosart,promov,".
				...
				"         '".$ai_candesart."','".$ad_fecdesart."','".$ls_codtie."','".$as_codproveedor."')";
		...
		else
		{
			////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� detalle del movimiento ".$as_nummov." del articulo ".$as_codart." nro de documento ".numdoc.
