...
?>
  <p align="center">
    <input name="operacion" type="hidden" id="operacion"  value="<? print $ls_operacion?>">
	 ...
	 <tr>
        <td><div align="right">C&eacute;dula/Rif</div></td>
        <td><div align="left">
...
if($ls_operacion=="BUSCAR")
{
 $ls_cadena=" SELECT * ".
			" FROM sfc_cliente ".
			" WHERE codest ilike '".$ls_codesta."'  AND razcli ilike '".$ls_razcli."'  AND cedcli ilike'".$ls_cedcli."' ";
			...
			else
			{
				...
				print "<td><font color=#FFFFFF>C&eacute;dula</font></td>";
				print "<td><font color=#FFFFFF>Raz&oacute;n Social</font></td>";
				print "</tr>";
				while($row=$io_sql->fetch_row($rs_datauni))
				{
					...
					print "<td><a href=\"javascript: aceptar('$codcli','$cedcli','$nomcli','$dircli','$telcli','$celcli','$codpai','$codest','$codmun','$codpar','$productor','$precioestandar');\">".$codcli."</a></td>";
...
<script language="JavaScript">
  function aceptar(codcli,cedcli,nomcli,dircli,telcli,celcli,codpai,codest,codmun,codpar,producto,precioestandar)
  {
	opener.ue_cargarcliente(codcli,cedcli,nomcli,dircli,telcli,celcli,codpai,codest,codmun,codpar,producto,precioestandar);
	close();
  }
  ...
  function ue_search()
  {
	...
	f.action="sigesp_cat_cliente1.php";
	f.submit();
  }
