...
public function printCentered2($img, $py, $color, $text, $fontFileName) {
			$this->printText($img, 25, $py, $color, $text, $fontFileName, $this->HORIZONTAL_CENTER_ALIGN | $this->VERTICAL_CENTER_ALIGN);
		}
		public function printCentered3($img, $py, $color, $text, $fontFileName) {
			$this->printText($img, 550, $py, $color, $text, $fontFileName, $this->HORIZONTAL_CENTER_ALIGN | $this->VERTICAL_CENTER_ALIGN);
		}
