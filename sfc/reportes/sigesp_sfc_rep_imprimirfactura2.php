...
$ls_serie=$_SESSION["ls_serfac"];
			...
			{ 
			   $la_facturacion=$io_sql->obtener_datos($rs_datauni);
			  	...
			  	//$reporte->add_titulo(112,-3,13,"    ".$ls_serie=$_SESSION["ls_serfac"]."               ".substr($la_facturacion["numfac"][1],21,4));
				//$reporte->add_titulo(112,-8,13,"    ".$ls_serie=$_SESSION["ls_serfac"]."- ".substr($la_facturacion["numfac"][1],21,4));
		 		$reporte->add_titulo(17,11,9,"".$la_facturacion["razcli"][1]);
								
				$ls_fecha="".substr($la_facturacion["fecemi"][1],8,2)."/".substr($la_facturacion["fecemi"][1],5,2)."/".substr($la_facturacion["fecemi"][1],0,4)."";	
				$reporte->add_titulo(155,11,9,"    ".$ls_fecha);		
				$reporte->add_titulo(17,14.5,9,"".$la_facturacion["dircli"][1]);
				$reporte->add_titulo(17,19.5,9,"   ".$la_facturacion["telcli"][1]);		
				$reporte->add_titulo(102,19.5,9,"".$la_facturacion["cedcli"][1]);
				...
				$reporte->add_titulo(20,24,9,"                                          ");  
				$reporte->add_titulo(120,24,9,"                              ".$ls_conpago);
			   ...
			   // ----  Detalles de la FACTURA  -------								
				...
				$la_anchos_col = array(15,125,27,28);
				...
				$la_opciones = array(  "color_fondo" => array(229,229,229), 
									   ...
									   "margen_horizontal"=>1);			   
				$io_pdf->add_tabla4(5,$la_datos,$la_opciones);
	...
	/************************************************************************************************************************/			
			   ...
			   $la_datos2[2]["resultados"]= "<b>".$la_total."</b>";  //TERCERA COLUMNA- FILA 2
				...
				$io_pdf->ezSetY(580-$li_cuotas*10);
				...
				$la_opciones2 = array( "color_fondo" => array(229,229,229), 
									   ...
									   "alineacion_col"=>$la_justificaciones,
									   "margen_horizontal"=>1);			   
				$io_pdf->add_tabla4(145,$la_datos2,$la_opciones2);
				// datos para la segunda columna
