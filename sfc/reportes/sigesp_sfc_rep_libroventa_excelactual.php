...
function redondeado ($numero, $decimales)
 {
   ...
   return (round($numero*$factor)/$factor);
	...
	//Par�metros para Filtar el Reporte
		...
		//$ls_rango    = "MES: ".$ls_mes."    "."A�O:".$ls_ano."";
	...
	// Impresi�n de la informaci�n encontrada en caso de que exista
		...
		else // Imprimimos el reporte
		{
			...
			$lo_hoja->write(5, 17, "Impuesto 1Alicuota Gral.",$lo_titulo);
...
$ls_cadena="Select dt.porimp,f.numfac,SUM(dt.canpro*dt.prepro) as baseimponible,SUM((dt.canpro*dt.prepro)*dt.porimp/100) as deduccion " .
		...
		" and dt.numfac='".$ls_numfac."' and f.numfac=dt.numfac and substring(f.fecemi,0,11) BETWEEN '".$as_fechadesde."' AND '".$as_fechahasta."'" .
...
$li_n=$li_n;
$ls_sql= "Select DISTINCT(d.numfac),d.coddev,d.numcon,d.codemp,d.codtiend,substring(d.fecdev,0,11) as fecdev,sfc_cliente.cedcli,sfc_cliente.razcli from sfc_devolucion d,sfc_cliente,sfc_factura f where d.codemp='".$ls_codemp."' and ".sql_dinamica ($ls_tienda_desde,$ls_tienda_hasta,'d',$ls_codtie)." and d.numfac=f.numfac and sfc_cliente.codcli=f.codcli  and substring(d.fecdev,0,11) BETWEEN '".$as_fechadesde."' AND '".$as_fechahasta."' ORDER BY d.fecdev ASC";
