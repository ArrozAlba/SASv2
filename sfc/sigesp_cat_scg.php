...
{
	$ls_cadena =" SELECT sc_cuenta, denominacion, status, asignado, distribuir,enero, febrero, marzo, abril, mayo, junio, " . 
		        "        julio, agosto, septiembre, octubre, noviembre, diciembre,nivel, referencia  ".
		        " FROM   scg_cuentas ".
		        " WHERE  codemp = '".$as_codemp."' AND sc_cuenta ilike '".$ls_codigo."' AND denominacion ilike '".$ls_denominacion."' AND ".
				"        status='C' ".
				" ORDER BY sc_cuenta";
...
<script language="JavaScript">
  ...
  {
    opener.ue_cargarctasscg(cuenta,d);
    close();
  }
