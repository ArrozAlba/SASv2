  ...
  <p align="center">
    ...
    <td width="334" ><input name="txtcodtie" type="hidden" id="txtcodtie" value="<? print $ls_codtiend;?>" size="5" maxlength="4"></td>
	 ...
	 <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
       ...
       <tr>
        <td width="96" height="30"><div align="right">Unidad Operativa de Suministro </div></td>
      ...
      <tr>
        <td width="96"><div align="right">Nombre</div></td>
...
if($ls_operacion=="BUSCAR")
{
 ...
 if ($ls_codtiend!="")
  {	$ls_cadena=" SELECT distinct on(c.codtiend, c.cod_caja) c.*, t.dentie ".
			   " FROM sfc_caja c, sfc_tienda t ".
			   " WHERE c.descripcion_caja ilike '".$ls_desccaja."' and c.codtiend='".$ls_codtiend."' " .
			   " AND c.codtiend=t.codtiend ORDER BY codtiend";
  }
   else
   {
   	$ls_cadena=" SELECT distinct on(c.codtiend, c.cod_caja) c.*, t.dentie ".
			   " FROM sfc_caja c, sfc_tienda t ".
			   " WHERE c.descripcion_caja ilike '".$ls_desccaja."' or c.codtiend='".$ls_codtiend."' " .
			   " AND c.codtiend=t.codtiend ORDER BY codtiend";
			...
			else
			{
				if($row=$io_sql->fetch_row($rs_datauni))
				{
					...
					print "<td><font color=#FFFFFF>N° Unidad Suministro</font></td>";
					print "<td><font color=#FFFFFF>N° Caja</font></td>";
					...
					for($z=1;$z<=$totrow;$z++)
					{
						...
						$ls_destienda=$io_data->getValue("dentie",$z);
						...
						$preordent=$io_data->getValue("preordent",$z);
						$serordent=$io_data->getValue("serordent",$z);

                        print "<td><a href=\"javascript: aceptar('$codtienda','$ls_destienda','$codcaja','$desccaja',
						      '$precot','$prefac','$predev','$preped','$sercot','$serfac','$serdev','$serped','$sernot',
							  '$sercon','$formalibre','$precob','$sercob','$preordent','$serordent');\">".$codtienda."</a></td>";
						print "<td align=left>".$codcaja."</td>";
