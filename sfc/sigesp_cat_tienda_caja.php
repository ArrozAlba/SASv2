  ...
  <p align="center">
    ...
    <td width="334" ><input name="txtcodtie" type="hidden" id="txtcodtie" value="<? print $ls_codtiend?>" size="5" maxlength="4"></td>
	 ...
	 <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
       ...
       <tr>
        <td width="122" height="30"><div align="right">Unidad Operativa de Suministro</div></td>
      ...
      <tr>
        <td width="122"><div align="right">Nombre</div></td>
 ...
 if ($ls_codtie!="")
  {	$ls_cadena=" SELECT * ".
   ...
   else
   {
   	$ls_cadena=" SELECT * ".
			   " FROM sfc_caja ".
			   " WHERE descripcion_caja ilike '".$ls_desccaja."' or codtiend='".$ls_codtie."' 
			     ORDER BY codtiend";
			...
			else
			{
				if($row=$io_sql->fetch_row($rs_datauni))
				{
					...
					print "<td><font color=#FFFFFF>N° de la Tienda</font></td>";
					print "<td><font color=#FFFFFF>N° de la Caja</font></td>";
					...
					for($z=1;$z<=$totrow;$z++)
					{
                        ...
                        print "<td><a href=\"javascript: aceptar('$codtienda','$ls_destienda','$codcaja','$desccaja',
							  ...
							  '$sercon','$formalibre','$precob','$sercob');\">".$codtienda."</a></td>";
