...
if($ls_operacion=="BUSCAR")
{
	...
	$ls_cadena =" SELECT *,(previsto+aumento-disminucion) as disponible 
				  FROM spi_cuentas 
		   		  WHERE codemp = '".$as_codemp."' AND spi_cuenta like '".$ls_codigo."' AND denominacion ilike '".$ls_denominacion."' AND sc_cuenta like '".$ls_codscg."' 
				  ORDER BY spi_cuenta";
...
<script language="JavaScript">
  ...
  {
    opener.ue_cargarctasspi(cuenta,deno);
	close();
  }
