...
{
 $ls_cadena=" SELECT c.codcli,c.razcli,c.cedcli FROM sfc_cliente c,sfc_nota n WHERE c.codcli=n.codcli AND n.tipnot='CXC' AND n.estnota='P'  AND n.numnot<>n.nro_factura AND c.codest ilike '".$ls_codesta."'  AND  c.razcli ilike '".$ls_razcli."'  AND c.codtie ilike '".$ls_codtien."' GROUP BY c.codcli,c.razcli,c.cedcli";
//print $ls_cadena;
...
<script language="JavaScript">
  ...
  f.action="sigesp_cat_clientecobranzacartas.php";
  f.submit();
  }
