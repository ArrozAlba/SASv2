...
<title>Anulaci&oacute;n de Factura # <?php echo $factura; ?></title>
...
<form name="form1" method="post" action="">
  <table width="382" height="88" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="22" colspan="2"><div align="center">Favor indique el motivo de la anulaci&oacute;n de la factura  <?php echo $factura; ?>: </div></td>
    </tr>
    <tr>
